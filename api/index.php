...
try
{
	...
	{	
		...
		$o_rememberMe = new RememberMe($o_users, $a_config['Auth']['RememberMe_PrivateKey']);
	...
	$o_controller = new $str_controller;	
...
{
	$str_filename = API_ROOT . "lib/$str_class_name.php";
