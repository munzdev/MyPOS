...
use \Exception;
use \PDO;
use API\Models\User\UserRoleQuery as ChildUserRoleQuery;
use API\Models\User\Map\UserRoleTableMap;
...
abstract class UserRole implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Models\\User\\Map\\UserRoleTableMap';
    ...
    /**
     * Initializes internal state of API\Models\User\Base\UserRole object.
     */
     ...
     * @return $this|\API\Models\User\UserRole The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\API\\Models\\User\\UserRole'), 0, $e);
        }
    }
     ...
     *                       TableMap::TYPE_PHPNAME.
     * @return $this|\API\Models\User\UserRole
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Models\User\UserRole The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param  object  $copyObj  An object of \API\Models\User\UserRole (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Models\User\UserRole Clone of current object.
     * @throws PropelException
     */
