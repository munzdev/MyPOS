...
class UserTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.User.Map.UserTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\User\\User';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.User.User';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\API\\Models\\User\\User');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\User\User) { // it's a model object
