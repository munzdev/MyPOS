...
class UsersTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.User.Map.UsersTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\User\\Users';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.User.Users';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\API\\Models\\User\\Users');
  ...
  array (
    ...
    1 => ':userid',
        ...
        $this->addRelation('Invoices', '\\API\\Models\\Invoice\\Invoices', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':cashier_userid',
    1 => ':userid',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\User\Users) { // it's a model object
