...
class UserRoleTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.User.Map.UserRoleTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\User\\UserRole';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.User.UserRole';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\API\\Models\\User\\UserRole');
...
*/
    ...
    public static function doDelete($values, ConnectionInterface $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\User\UserRole) { // it's a model object
