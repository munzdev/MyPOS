 ...
 *
 * @method     \API\Models\Event\EventUserQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class UserMessageQuery extends ModelCriteria
{
     ...
     *
     * @param \API\Models\Event\EventUser|ObjectCollection $eventUser The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    public function useEventUserRelatedByFromEventUseridQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'EventUserRelatedByFromEventUserid', '\API\Models\Event\EventUserQuery');
    }
    ...
    public function useEventUserRelatedByToEventUseridQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'EventUserRelatedByToEventUserid', '\API\Models\Event\EventUserQuery');
    }
