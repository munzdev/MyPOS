...
class DistributionPlaceTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.ORM.DistributionPlace.Map.DistributionPlaceTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\ORM\\DistributionPlace\\DistributionPlace';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.ORM.DistributionPlace.DistributionPlace';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\API\\Models\\ORM\\DistributionPlace\\DistributionPlace');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\ORM\DistributionPlace\DistributionPlace) { // it's a model object
