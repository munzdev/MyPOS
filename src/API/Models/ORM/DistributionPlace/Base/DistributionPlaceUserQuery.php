 ...
 *
 * @method     \API\Models\ORM\DistributionPlace\DistributionPlaceQuery|\API\Models\ORM\User\UserQuery|\API\Models\ORM\Event\EventPrinterQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class DistributionPlaceUserQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \API\Models\ORM\DistributionPlace\Base\DistributionPlaceUserQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\API\\Models\\ORM\\DistributionPlace\\DistributionPlaceUser', $modelAlias = null)
    {
     ...
     *
     * @param \API\Models\ORM\Event\EventPrinter|ObjectCollection $eventPrinter The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
