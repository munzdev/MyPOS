...
use API\Models\ORM\DistributionPlace\DistributionPlaceUser as ChildDistributionPlaceUser;
use API\Models\ORM\DistributionPlace\DistributionPlaceUserQuery as ChildDistributionPlaceUserQuery;
...
abstract class DistributionPlace implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Models\\ORM\\DistributionPlace\\Map\\DistributionPlaceTableMap';
    ...
    /**
     * Initializes internal state of API\Models\ORM\DistributionPlace\Base\DistributionPlace object.
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\API\\Models\\ORM\\DistributionPlace\\DistributionPlace'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->distributionPlaceGroupsScheduledForDeletion !== null) {
                if (!$this->distributionPlaceGroupsScheduledForDeletion->isEmpty()) {
                    \API\Models\ORM\DistributionPlace\DistributionPlaceGroupQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\API\Models\ORM\DistributionPlace\DistributionPlace
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Models\ORM\DistributionPlace\DistributionPlace The current object, for fluid interface
     */
    ...
    /**
     * Generic method to set the primary key (distribution_placeid column).
     *
    ...
    {
        $this->setDistributionPlaceid($key);
    }
    ...
    {
        return null === $this->getDistributionPlaceid();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \API\Models\ORM\DistributionPlace\DistributionPlace (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Models\ORM\DistributionPlace\DistributionPlace Clone of current object.
     * @throws PropelException
     */
