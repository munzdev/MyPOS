 ...
 *
 * @method     \API\Models\ORM\Event\EventQuery|\API\Models\ORM\DistributionPlace\DistributionPlaceGroupQuery|\API\Models\ORM\DistributionPlace\DistributionPlaceUserQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class DistributionPlaceQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \API\Models\ORM\DistributionPlace\Base\DistributionPlaceQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\API\\Models\\ORM\\DistributionPlace\\DistributionPlace', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \API\Models\ORM\DistributionPlace\DistributionPlaceGroup object
     *
     * @param \API\Models\ORM\DistributionPlace\DistributionPlaceGroup|ObjectCollection $distributionPlaceGroup the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildDistributionPlaceQuery The current query, for fluid interface
     */
    ...
    {
        if ($distributionPlaceGroup instanceof \API\Models\ORM\DistributionPlace\DistributionPlaceGroup) {
            return $this
            ...
            throw new PropelException('filterByDistributionPlaceGroup() only accepts arguments of type \API\Models\ORM\DistributionPlace\DistributionPlaceGroup or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \API\Models\ORM\DistributionPlace\DistributionPlaceGroupQuery A secondary query class using the current class as primary query
     */
    public function useDistributionPlaceGroupQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'DistributionPlaceGroup', '\API\Models\ORM\DistributionPlace\DistributionPlaceGroupQuery');
    }
