 ...
 *
 * @method     \API\Models\ORM\DistributionPlace\DistributionPlaceGroupQuery|\API\Models\ORM\Event\EventTableQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class DistributionPlaceTableQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \API\Models\ORM\DistributionPlace\Base\DistributionPlaceTableQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\API\\Models\\ORM\\DistributionPlace\\DistributionPlaceTable', $modelAlias = null)
    {
     ...
     *
     * @param \API\Models\ORM\DistributionPlace\DistributionPlaceGroup|ObjectCollection $distributionPlaceGroup The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
