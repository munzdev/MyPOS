 ...
 * @method     ChildInvoiceQuery orderByOrderid($order = Criteria::ASC) Order by the orderid column
 ...
 * @method     ChildInvoiceQuery groupByOrderid() Group by the orderid column
 ...
 *
 * @method     ChildInvoiceQuery leftJoinOrder($relationAlias = null) Adds a LEFT JOIN clause to the query using the Order relation
 * @method     ChildInvoiceQuery rightJoinOrder($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Order relation
 * @method     ChildInvoiceQuery innerJoinOrder($relationAlias = null) Adds a INNER JOIN clause to the query using the Order relation
 *
 * @method     ChildInvoiceQuery joinWithOrder($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Order relation
 *
 * @method     ChildInvoiceQuery leftJoinWithOrder() Adds a LEFT JOIN clause and with to the query using the Order relation
 * @method     ChildInvoiceQuery rightJoinWithOrder() Adds a RIGHT JOIN clause and with to the query using the Order relation
 * @method     ChildInvoiceQuery innerJoinWithOrder() Adds a INNER JOIN clause and with to the query using the Order relation
 *
 ...
 *
 * @method     \API\Models\ORM\Event\EventContactQuery|\API\Models\ORM\Event\EventBankinformationQuery|\API\Models\ORM\Invoice\InvoiceQuery|\API\Models\ORM\Invoice\InvoiceTypeQuery|\API\Models\ORM\Ordering\OrderQuery|\API\Models\ORM\User\UserQuery|\API\Models\ORM\Invoice\InvoiceItemQuery|\API\Models\ORM\Invoice\InvoiceWarningQuery|\API\Models\ORM\Payment\PaymentRecievedQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildInvoice findOneByOrderid(int $orderid) Return the first ChildInvoice filtered by the orderid column
 ...
 * @method     ChildInvoice requireOneByOrderid(int $orderid) Return the first ChildInvoice filtered by the orderid column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildInvoice[]|ObjectCollection findByOrderid(int $orderid) Return ChildInvoice objects filtered by the orderid column
...
abstract class InvoiceQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \API\Models\ORM\Invoice\Base\InvoiceQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\API\\Models\\ORM\\Invoice\\Invoice', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `invoiceid`, `invoice_typeid`, `event_contactid`, `userid`, `event_bankinformationid`, `customer_event_contactid`, `canceled_invoiceid`, `orderid`, `date`, `amount`, `maturity_date`, `payment_finished`, `amount_recieved` FROM `invoice` WHERE `invoiceid` = :p0';
        try {
    ...
    public function filterByOrderid($orderid = null, $comparison = null)
    {
        if (is_array($orderid)) {
            ...
            if (isset($orderid['min'])) {
                $this->addUsingAlias(InvoiceTableMap::COL_ORDERID, $orderid['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($orderid['max'])) {
                $this->addUsingAlias(InvoiceTableMap::COL_ORDERID, $orderid['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(InvoiceTableMap::COL_ORDERID, $orderid, $comparison);
    }
     ...
     *
     * @param \API\Models\ORM\Event\EventContact|ObjectCollection $eventContact The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    public function filterByEventContactRelatedByCustomerEventContactid($eventContact, $comparison = null)
    {
        if ($eventContact instanceof \API\Models\ORM\Event\EventContact) {
            ...
            throw new PropelException('filterByEventContactRelatedByCustomerEventContactid() only accepts arguments of type \API\Models\ORM\Event\EventContact or Collection');
        }
    }
    ...
    public function useEventContactRelatedByCustomerEventContactidQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'EventContactRelatedByCustomerEventContactid', '\API\Models\ORM\Event\EventContactQuery');
    }

    /**
     * Filter the query by a related \API\Models\ORM\Event\EventBankinformation object
     *
     * @param \API\Models\ORM\Event\EventBankinformation|ObjectCollection $eventBankinformation The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    public function filterByEventContactRelatedByEventContactid($eventContact, $comparison = null)
    {
        if ($eventContact instanceof \API\Models\ORM\Event\EventContact) {
            ...
            throw new PropelException('filterByEventContactRelatedByEventContactid() only accepts arguments of type \API\Models\ORM\Event\EventContact or Collection');
        }
    }
    ...
    public function useEventContactRelatedByEventContactidQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'EventContactRelatedByEventContactid', '\API\Models\ORM\Event\EventContactQuery');
    }
    ...
    public function filterByInvoiceRelatedByCanceledInvoiceid($invoice, $comparison = null)
    {
        if ($invoice instanceof \API\Models\ORM\Invoice\Invoice) {
            ...
            throw new PropelException('filterByInvoiceRelatedByCanceledInvoiceid() only accepts arguments of type \API\Models\ORM\Invoice\Invoice or Collection');
        }
    }
    ...
    public function useInvoiceRelatedByCanceledInvoiceidQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'InvoiceRelatedByCanceledInvoiceid', '\API\Models\ORM\Invoice\InvoiceQuery');
    }

    /**
     * Filter the query by a related \API\Models\ORM\Invoice\InvoiceType object
     *
     * @param \API\Models\ORM\Invoice\InvoiceType|ObjectCollection $invoiceType The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($invoiceType instanceof \API\Models\ORM\Invoice\InvoiceType) {
            return $this
            ...
            throw new PropelException('filterByInvoiceType() only accepts arguments of type \API\Models\ORM\Invoice\InvoiceType or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \API\Models\ORM\Invoice\InvoiceTypeQuery A secondary query class using the current class as primary query
     */
    public function useInvoiceTypeQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'InvoiceType', '\API\Models\ORM\Invoice\InvoiceTypeQuery');
    }
    ...
    public function filterByOrder($order, $comparison = null)
    {
        if ($order instanceof \API\Models\ORM\Ordering\Order) {
            return $this
                ->addUsingAlias(InvoiceTableMap::COL_ORDERID, $order->getOrderid(), $comparison);
            ...
            return $this
                ->addUsingAlias(InvoiceTableMap::COL_ORDERID, $order->toKeyValue('PrimaryKey', 'Orderid'), $comparison);
        } else {
    ...
    public function filterByInvoiceRelatedByInvoiceid($invoice, $comparison = null)
    {
        if ($invoice instanceof \API\Models\ORM\Invoice\Invoice) {
            ...
            throw new PropelException('filterByInvoiceRelatedByInvoiceid() only accepts arguments of type \API\Models\ORM\Invoice\Invoice or Collection');
        }
    }
    ...
    public function useInvoiceRelatedByInvoiceidQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'InvoiceRelatedByInvoiceid', '\API\Models\ORM\Invoice\InvoiceQuery');
    }
    ...
    /**
     * Filter the query by a related \API\Models\ORM\Invoice\InvoiceWarning object
     *
     * @param \API\Models\ORM\Invoice\InvoiceWarning|ObjectCollection $invoiceWarning the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildInvoiceQuery The current query, for fluid interface
     */
    ...
    {
        if ($invoiceWarning instanceof \API\Models\ORM\Invoice\InvoiceWarning) {
            return $this
            ...
            throw new PropelException('filterByInvoiceWarning() only accepts arguments of type \API\Models\ORM\Invoice\InvoiceWarning or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \API\Models\ORM\Invoice\InvoiceWarningQuery A secondary query class using the current class as primary query
     */
    public function useInvoiceWarningQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'InvoiceWarning', '\API\Models\ORM\Invoice\InvoiceWarningQuery');
    }
