 ...
 *
 * @method     \API\Models\ORM\Event\EventQuery|\API\Models\ORM\Invoice\InvoiceWarningQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class InvoiceWarningTypeQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \API\Models\ORM\Invoice\Base\InvoiceWarningTypeQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\API\\Models\\ORM\\Invoice\\InvoiceWarningType', $modelAlias = null)
    {
