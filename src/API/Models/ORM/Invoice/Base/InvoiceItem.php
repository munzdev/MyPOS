...
abstract class InvoiceItem implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Models\\ORM\\Invoice\\Map\\InvoiceItemTableMap';
    ...
    /**
     * Initializes internal state of API\Models\ORM\Invoice\Base\InvoiceItem object.
     */
    ...
    /**
     * Compares this with another <code>InvoiceItem</code> instance.  If
     * <code>obj</code> is an instance of <code>InvoiceItem</code>, delegates to
     * <code>equals(InvoiceItem)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|InvoiceItem The current object, for fluid interface
     */
     ...
     */
    public function setInvoiceItemid($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->invoice_itemid !== $v) {
            $this->invoice_itemid = $v;
            $this->modifiedColumns[InvoiceItemTableMap::COL_INVOICE_ITEMID] = true;
        }
    ...
    public function setInvoiceid($v)
    {
        ...
        if ($this->invoiceid !== $v) {
            $this->invoiceid = $v;
            $this->modifiedColumns[InvoiceItemTableMap::COL_INVOICEID] = true;
        }
    ...
    public function setOrderDetailid($v)
    {
        ...
        if ($this->order_detailid !== $v) {
            ...
            $this->modifiedColumns[InvoiceItemTableMap::COL_ORDER_DETAILID] = true;
        }
    ...
    public function setAmount($v)
    {
        ...
        if ($this->amount !== $v) {
            $this->amount = $v;
            $this->modifiedColumns[InvoiceItemTableMap::COL_AMOUNT] = true;
        }
    ...
    public function setPrice($v)
    {
        ...
        if ($this->price !== $v) {
            $this->price = $v;
            $this->modifiedColumns[InvoiceItemTableMap::COL_PRICE] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[InvoiceItemTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setTax($v)
    {
        ...
        if ($this->tax !== $v) {
            $this->tax = $v;
            $this->modifiedColumns[InvoiceItemTableMap::COL_TAX] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : InvoiceItemTableMap::translateFieldName('InvoiceItemid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->invoice_itemid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : InvoiceItemTableMap::translateFieldName('Invoiceid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->invoiceid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : InvoiceItemTableMap::translateFieldName('OrderDetailid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->order_detailid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : InvoiceItemTableMap::translateFieldName('Amount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->amount = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : InvoiceItemTableMap::translateFieldName('Price', TableMap::TYPE_PHPNAME, $indexType)];
            $this->price = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : InvoiceItemTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : InvoiceItemTableMap::translateFieldName('Tax', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 7; // 7 = InvoiceItemTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\API\\Models\\ORM\\Invoice\\InvoiceItem'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildInvoiceItemQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see InvoiceItem::setDeleted()
     * @see InvoiceItem::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildInvoiceItemQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                InvoiceItemTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    {
        $pos = InvoiceItemTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['InvoiceItem'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['InvoiceItem'][$this->hashCode()] = true;
        $keys = InvoiceItemTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getInvoiceItemid(),
            $keys[1] => $this->getInvoiceid(),
            $keys[2] => $this->getOrderDetailid(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\API\Models\ORM\Invoice\InvoiceItem
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setInvoiceItemid($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setInvoiceid($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setOrderDetailid($arr[$keys[2]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Models\ORM\Invoice\InvoiceItem The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(InvoiceItemTableMap::COL_AMOUNT)) {
            $criteria->add(InvoiceItemTableMap::COL_AMOUNT, $this->amount);
        }
        if ($this->isColumnModified(InvoiceItemTableMap::COL_PRICE)) {
            $criteria->add(InvoiceItemTableMap::COL_PRICE, $this->price);
        }
        if ($this->isColumnModified(InvoiceItemTableMap::COL_DESCRIPTION)) {
            $criteria->add(InvoiceItemTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(InvoiceItemTableMap::COL_TAX)) {
            $criteria->add(InvoiceItemTableMap::COL_TAX, $this->tax);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \API\Models\ORM\Invoice\InvoiceItem (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setInvoiceItemid(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Models\ORM\Invoice\InvoiceItem Clone of current object.
     * @throws PropelException
     */
    ...
    public function getOrderDetail(ConnectionInterface $con = null)
    {
        if ($this->aOrderDetail === null && ($this->order_detailid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aOrderDetail->addInvoiceItems($this);
             */
        }
    ...
    {
        if (null !== $this->aInvoice) {
            $this->aInvoice->removeInvoiceItem($this);
        }
        if (null !== $this->aOrderDetail) {
            $this->aOrderDetail->removeInvoiceItem($this);
        }
        $this->invoice_itemid = null;
        $this->invoiceid = null;
    ...
    {
        return (string) $this->exportTo(InvoiceItemTableMap::DEFAULT_STRING_FORMAT);
    }
