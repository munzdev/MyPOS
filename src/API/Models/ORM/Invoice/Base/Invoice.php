...
abstract class Invoice implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Models\\ORM\\Invoice\\Map\\InvoiceTableMap';
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->invoiceItemsScheduledForDeletion !== null) {
                if (!$this->invoiceItemsScheduledForDeletion->isEmpty()) {
                    \API\Models\ORM\Invoice\InvoiceItemQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\API\Models\ORM\Invoice\Invoice
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Models\ORM\Invoice\Invoice The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \API\Models\ORM\Invoice\Invoice (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Models\ORM\Invoice\Invoice Clone of current object.
     * @throws PropelException
     */
    ...
    public function initInvoicesRelatedByInvoiceid($overrideExisting = true)
    {
        ...
        $this->collInvoicesRelatedByInvoiceid->setModel('\API\Models\ORM\Invoice\Invoice');
    }
