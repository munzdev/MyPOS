...
class InvoiceWarningTypeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.ORM.Invoice.Map.InvoiceWarningTypeTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\ORM\\Invoice\\InvoiceWarningType';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.ORM.Invoice.InvoiceWarningType';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\API\\Models\\ORM\\Invoice\\InvoiceWarningType');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\ORM\Invoice\InvoiceWarningType) { // it's a model object
