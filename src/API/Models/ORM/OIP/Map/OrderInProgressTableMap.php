...
class OrderInProgressTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.ORM.OIP.Map.OrderInProgressTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\ORM\\OIP\\OrderInProgress';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.ORM.OIP.OrderInProgress';
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\ORM\OIP\OrderInProgress) { // it's a model object
