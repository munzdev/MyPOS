...
namespace API\Models\ORM\OIP\Map;
...
class OrderInProgressRecievedTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.ORM.OIP.Map.OrderInProgressRecievedTableMap';
     ...
     */
    const TABLE_NAME = 'order_in_progress_recieved';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\API\\Models\\ORM\\OIP\\OrderInProgressRecieved';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.ORM.OIP.OrderInProgressRecieved';
    ...
    /**
     * the column name for the order_in_progress_recievedid field
     */
    const COL_ORDER_IN_PROGRESS_RECIEVEDID = 'order_in_progress_recieved.order_in_progress_recievedid';

    /**
     * the column name for the order_detailid field
     */
    const COL_ORDER_DETAILID = 'order_in_progress_recieved.order_detailid';

    /**
     * the column name for the order_in_progressid field
     */
    const COL_ORDER_IN_PROGRESSID = 'order_in_progress_recieved.order_in_progressid';

    /**
     * the column name for the distribution_giving_outid field
     */
    const COL_DISTRIBUTION_GIVING_OUTID = 'order_in_progress_recieved.distribution_giving_outid';

    /**
     * the column name for the amount field
     */
    const COL_AMOUNT = 'order_in_progress_recieved.amount';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_FIELDNAME     => array('order_in_progress_recievedid', 'order_detailid', 'order_in_progressid', 'distribution_giving_outid', 'amount', ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_FIELDNAME     => array('order_in_progress_recievedid' => 0, 'order_detailid' => 1, 'order_in_progressid' => 2, 'distribution_giving_outid' => 3, 'amount' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
  ...
  array (
    ...
    1 => ':order_detailid',
        ...
        $this->addRelation('OrderInProgress', '\\API\\Models\\ORM\\OIP\\OrderInProgress', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    ...
    1 => ':order_in_progressid',
        ...
        $this->addRelation('DistributionGivingOut', '\\API\\Models\\ORM\\OIP\\DistributionGivingOut', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    ...
    {
        return $withPrefix ? OrderInProgressRecievedTableMap::CLASS_DEFAULT : OrderInProgressRecievedTableMap::OM_CLASS;
    }
     ...
     * @return array           (OrderInProgressRecieved object, last column rank)
     */
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        $key = OrderInProgressRecievedTableMap::getPrimaryKeyHashFromRow($row, $offset, $indexType);
        if (null !== ($obj = OrderInProgressRecievedTableMap::getInstanceFromPool($key))) {
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = OrderInProgressRecievedTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = OrderInProgressRecievedTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(OrderInProgressRecievedTableMap::COL_ORDER_IN_PROGRESS_RECIEVEDID);
            $criteria->addSelectColumn(OrderInProgressRecievedTableMap::COL_ORDER_DETAILID);
            $criteria->addSelectColumn(OrderInProgressRecievedTableMap::COL_ORDER_IN_PROGRESSID);
            $criteria->addSelectColumn(OrderInProgressRecievedTableMap::COL_DISTRIBUTION_GIVING_OUTID);
            $criteria->addSelectColumn(OrderInProgressRecievedTableMap::COL_AMOUNT);
        } else {
            $criteria->addSelectColumn($alias . '.order_in_progress_recievedid');
    ...
    {
        return Propel::getServiceContainer()->getDatabaseMap(OrderInProgressRecievedTableMap::DATABASE_NAME)->getTable(OrderInProgressRecievedTableMap::TABLE_NAME);
    }
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(OrderInProgressRecievedTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(OrderInProgressRecievedTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new OrderInProgressRecievedTableMap());
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\ORM\OIP\OrderInProgressRecieved) { // it's a model object
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ((array) $values as $singleval) {
                OrderInProgressRecievedTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    {
        return OrderInProgressRecievedQuery::create()->doDeleteAll($con);
    }
...
//
OrderInProgressRecievedTableMap::buildTableMap();
