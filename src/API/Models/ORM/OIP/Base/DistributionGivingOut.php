...
use API\Models\ORM\OIP\Map\DistributionGivingOutTableMap;
...
abstract class DistributionGivingOut implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Models\\ORM\\OIP\\Map\\DistributionGivingOutTableMap';
    ...
    /**
     * Initializes internal state of API\Models\ORM\OIP\Base\DistributionGivingOut object.
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\API\\Models\\ORM\\OIP\\DistributionGivingOut'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\API\Models\ORM\OIP\DistributionGivingOut
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Models\ORM\OIP\DistributionGivingOut The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \API\Models\ORM\OIP\DistributionGivingOut (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Models\ORM\OIP\DistributionGivingOut Clone of current object.
     * @throws PropelException
     */
