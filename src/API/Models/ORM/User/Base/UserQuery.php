...
namespace API\Models\ORM\User\Base;
...
use API\Models\ORM\User\User as ChildUser;
use API\Models\ORM\User\UserQuery as ChildUserQuery;
use API\Models\ORM\User\Map\UserTableMap;
 ...
 *
 * @method     \API\Models\ORM\Payment\CouponQuery|\API\Models\ORM\DistributionPlace\DistributionPlaceUserQuery|\API\Models\ORM\Event\EventUserQuery|\API\Models\ORM\Invoice\InvoiceQuery|\API\Models\ORM\Ordering\OrderQuery|\API\Models\ORM\Ordering\OrderDetailQuery|\API\Models\ORM\OIP\OrderInProgressQuery|\API\Models\ORM\Payment\PaymentRecievedQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class UserQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \API\Models\ORM\User\Base\UserQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\API\\Models\\ORM\\User\\User', $modelAlias = null)
    {
     ...
     *
     * @param \API\Models\ORM\Ordering\Order|ObjectCollection $order the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildUserQuery The current query, for fluid interface
     */
    public function filterByOrderRelatedByCancellationCreatedByUserid($order, $comparison = null)
    {
        if ($order instanceof \API\Models\ORM\Ordering\Order) {
            ...
            throw new PropelException('filterByOrderRelatedByCancellationCreatedByUserid() only accepts arguments of type \API\Models\ORM\Ordering\Order or Collection');
        }
    }
    ...
    public function useOrderRelatedByCancellationCreatedByUseridQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'OrderRelatedByCancellationCreatedByUserid', '\API\Models\ORM\Ordering\OrderQuery');
    }
    ...
    public function filterByOrderRelatedByUserid($order, $comparison = null)
    {
        if ($order instanceof \API\Models\ORM\Ordering\Order) {
            ...
            throw new PropelException('filterByOrderRelatedByUserid() only accepts arguments of type \API\Models\ORM\Ordering\Order or Collection');
        }
    }
    ...
    public function useOrderRelatedByUseridQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'OrderRelatedByUserid', '\API\Models\ORM\Ordering\OrderQuery');
    }
