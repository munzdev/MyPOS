...
use API\Models\ORM\DistributionPlace\Base\DistributionPlaceUser as BaseDistributionPlaceUser;
use API\Models\ORM\DistributionPlace\Map\DistributionPlaceUserTableMap;
use API\Models\ORM\Event\EventUser;
use API\Models\ORM\Event\EventUserQuery;
use API\Models\ORM\Event\Base\EventUser as BaseEventUser;
...
use API\Models\ORM\OIP\Base\OrderInProgress as BaseOrderInProgress;
...
use API\Models\ORM\Ordering\Base\OrderDetail as BaseOrderDetail;
...
abstract class User implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Models\\ORM\\User\\Map\\UserTableMap';
    ...
    /**
     * Initializes internal state of API\Models\ORM\User\Base\User object.
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\API\\Models\\ORM\\User\\User'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->distributionPlaceUsersScheduledForDeletion !== null) {
                if (!$this->distributionPlaceUsersScheduledForDeletion->isEmpty()) {
                    \API\Models\ORM\DistributionPlace\DistributionPlaceUserQuery::create()
            ...
            if ($this->orderInProgressesScheduledForDeletion !== null) {
                if (!$this->orderInProgressesScheduledForDeletion->isEmpty()) {
                    \API\Models\ORM\OIP\OrderInProgressQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\API\Models\ORM\User\User
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Models\ORM\User\User The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \API\Models\ORM\User\User (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Models\ORM\User\User Clone of current object.
     * @throws PropelException
     */
    ...
    public function initDistributionPlaceUsers($overrideExisting = true)
    {
        ...
        $this->collDistributionPlaceUsers->setModel('\API\Models\ORM\DistributionPlace\DistributionPlaceUser');
    }
    ...
    public function initOrdersRelatedByCancellationCreatedByUserid($overrideExisting = true)
    {
        ...
        $this->collOrdersRelatedByCancellationCreatedByUserid->setModel('\API\Models\ORM\Ordering\Order');
    }
    ...
    public function initOrdersRelatedByUserid($overrideExisting = true)
    {
        ...
        $this->collOrdersRelatedByUserid->setModel('\API\Models\ORM\Ordering\Order');
    }
    ...
    public function initOrderDetails($overrideExisting = true)
    {
        ...
        $this->collOrderDetails->setModel('\API\Models\ORM\Ordering\OrderDetail');
    }
    ...
    public function initOrderInProgresses($overrideExisting = true)
    {
        ...
        $this->collOrderInProgresses->setModel('\API\Models\ORM\OIP\OrderInProgress');
    }
