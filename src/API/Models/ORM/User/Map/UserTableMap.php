...
class UserTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.ORM.User.Map.UserTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\ORM\\User\\User';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.ORM.User.User';
     ...
     */
    const COL_CALL_REQUEST = 'user.call_request';
  ...
  array (
    ...
    1 => ':userid',
        ...
        $this->addRelation('OrderRelatedByCancellationCreatedByUserid', '\\API\\Models\\ORM\\Ordering\\Order', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    ...
    1 => ':userid',
        ...
        $this->addRelation('OrderRelatedByUserid', '\\API\\Models\\ORM\\Ordering\\Order', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':userid',
    1 => ':userid',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\ORM\User\User) { // it's a model object
