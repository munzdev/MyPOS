...
class OrderDetailTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.ORM.Ordering.Map.OrderDetailTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\ORM\\Ordering\\OrderDetail';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.ORM.Ordering.OrderDetail';
  ...
  array (
    ...
    1 => ':order_detailid',
        ...
        $this->addRelation('OrderInProgressRecieved', '\\API\\Models\\ORM\\OIP\\OrderInProgressRecieved', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':order_detailid',
    1 => ':order_detailid',
        ...
        $this->addRelation('MenuPossibleExtra', '\\API\\Models\\ORM\\Menu\\MenuPossibleExtra', RelationMap::MANY_TO_MANY, array(), null, null, 'MenuPossibleExtras');
    } // buildRelations()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\ORM\Ordering\OrderDetail) { // it's a model object
