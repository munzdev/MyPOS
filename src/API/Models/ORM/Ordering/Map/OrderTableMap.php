...
class OrderTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.ORM.Ordering.Map.OrderTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\ORM\\Ordering\\Order';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.ORM.Ordering.Order';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\API\\Models\\ORM\\Ordering\\Order');
    ...
    {
        $this->addRelation('UserRelatedByCancellationCreatedByUserid', '\\API\\Models\\ORM\\User\\User', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
  ...
  array (
    ...
    1 => ':event_tableid',
        ...
        $this->addRelation('UserRelatedByUserid', '\\API\\Models\\ORM\\User\\User', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':userid',
    1 => ':userid',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\ORM\Ordering\Order) { // it's a model object
