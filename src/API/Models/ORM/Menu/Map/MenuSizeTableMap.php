...
class MenuSizeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.ORM.Menu.Map.MenuSizeTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\ORM\\Menu\\MenuSize';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.ORM.Menu.MenuSize';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\API\\Models\\ORM\\Menu\\MenuSize');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\ORM\Menu\MenuSize) { // it's a model object
