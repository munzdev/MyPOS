...
class AvailabilityTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.ORM.Menu.Map.AvailabilityTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\ORM\\Menu\\Availability';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.ORM.Menu.Availability';
     ...
     */
    const COL_AVAILABILITYID = 'availability.availabilityid';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'availability.name';
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(AvailabilityTableMap::COL_AVAILABILITYID);
            $criteria->addSelectColumn(AvailabilityTableMap::COL_NAME);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\ORM\Menu\Availability) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(AvailabilityTableMap::DATABASE_NAME);
            $criteria->add(AvailabilityTableMap::COL_AVAILABILITYID, (array) $values, Criteria::IN);
        }
