...
use API\Models\ORM\Menu\MenuPossibleExtra as ChildMenuPossibleExtra;
use API\Models\ORM\Menu\MenuPossibleExtraQuery as ChildMenuPossibleExtraQuery;
...
use API\Models\ORM\Ordering\Base\OrderDetailExtra as BaseOrderDetailExtra;
...
abstract class MenuPossibleExtra implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Models\\ORM\\Menu\\Map\\MenuPossibleExtraTableMap';
    ...
    /**
     * Initializes internal state of API\Models\ORM\Menu\Base\MenuPossibleExtra object.
     */
     ...
     * @return $this|\API\Models\ORM\Menu\MenuPossibleExtra The current object (for fluent API support)
     */
    ...
    public function setIsDeleted($v)
    {
        ...
        if ($this->is_deleted !== null || $dt !== null) {
            if ($this->is_deleted === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->is_deleted->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[MenuPossibleExtraTableMap::COL_IS_DELETED] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : MenuPossibleExtraTableMap::translateFieldName('IsDeleted', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = MenuPossibleExtraTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\API\\Models\\ORM\\Menu\\MenuPossibleExtra'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MenuPossibleExtraTableMap::COL_IS_DELETED)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\API\Models\ORM\Menu\MenuPossibleExtra
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Models\ORM\Menu\MenuPossibleExtra The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MenuPossibleExtraTableMap::COL_IS_DELETED)) {
            $criteria->add(MenuPossibleExtraTableMap::COL_IS_DELETED, $this->is_deleted);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \API\Models\ORM\Menu\MenuPossibleExtra (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Models\ORM\Menu\MenuPossibleExtra Clone of current object.
     * @throws PropelException
     */
