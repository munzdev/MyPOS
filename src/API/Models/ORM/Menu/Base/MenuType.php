...
use API\Models\ORM\Menu\MenuGroup as ChildMenuGroup;
use API\Models\ORM\Menu\MenuGroupQuery as ChildMenuGroupQuery;
...
abstract class MenuType implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Models\\ORM\\Menu\\Map\\MenuTypeTableMap';
    ...
    /**
     * Initializes internal state of API\Models\ORM\Menu\Base\MenuType object.
     */
    ...
    /**
     * Compares this with another <code>MenuType</code> instance.  If
     * <code>obj</code> is an instance of <code>MenuType</code>, delegates to
     * <code>equals(MenuType)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|MenuType The current object, for fluid interface
     */
    ...
    public function setMenuTypeid($v)
    {
        ...
        if ($this->menu_typeid !== $v) {
            $this->menu_typeid = $v;
            $this->modifiedColumns[MenuTypeTableMap::COL_MENU_TYPEID] = true;
        }
    ...
    public function setEventid($v)
    {
        ...
        if ($this->eventid !== $v) {
            $this->eventid = $v;
            $this->modifiedColumns[MenuTypeTableMap::COL_EVENTID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[MenuTypeTableMap::COL_NAME] = true;
        }
    ...
    public function setTax($v)
    {
        ...
        if ($this->tax !== $v) {
            $this->tax = $v;
            $this->modifiedColumns[MenuTypeTableMap::COL_TAX] = true;
        }
    ...
    public function setAllowmixing($v)
    {
        ...
        if ($this->allowmixing !== $v) {
            $this->allowmixing = $v;
            $this->modifiedColumns[MenuTypeTableMap::COL_ALLOWMIXING] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MenuTypeTableMap::translateFieldName('MenuTypeid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->menu_typeid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MenuTypeTableMap::translateFieldName('Eventid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->eventid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : MenuTypeTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : MenuTypeTableMap::translateFieldName('Tax', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildMenuTypeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see MenuType::setDeleted()
     * @see MenuType::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildMenuTypeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MenuTypeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->menuGroupsScheduledForDeletion !== null) {
                if (!$this->menuGroupsScheduledForDeletion->isEmpty()) {
                    \API\Models\ORM\Menu\MenuGroupQuery::create()
    ...
    {
        $pos = MenuTypeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['MenuType'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['MenuType'][$this->hashCode()] = true;
        $keys = MenuTypeTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\API\Models\ORM\Menu\MenuType
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Models\ORM\Menu\MenuType The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MenuTypeTableMap::COL_NAME)) {
            $criteria->add(MenuTypeTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(MenuTypeTableMap::COL_TAX)) {
            $criteria->add(MenuTypeTableMap::COL_TAX, $this->tax);
        }
        if ($this->isColumnModified(MenuTypeTableMap::COL_ALLOWMIXING)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \API\Models\ORM\Menu\MenuType (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Models\ORM\Menu\MenuType Clone of current object.
     * @throws PropelException
     */
    ...
    public function initMenuGroups($overrideExisting = true)
    {
        ...
        $this->collMenuGroups->setModel('\API\Models\ORM\Menu\MenuGroup');
    }
     ...
     * If this ChildMenuType is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildMenuType The current object (for fluent API support)
     */
    ...
    {
        if (null !== $this->aEvent) {
            $this->aEvent->removeMenuType($this);
        }
    ...
    {
        return (string) $this->exportTo(MenuTypeTableMap::DEFAULT_STRING_FORMAT);
    }
