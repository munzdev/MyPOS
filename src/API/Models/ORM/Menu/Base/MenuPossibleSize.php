...
use API\Models\ORM\Menu\MenuQuery as ChildMenuQuery;
use API\Models\ORM\Menu\MenuSize as ChildMenuSize;
use API\Models\ORM\Menu\MenuSizeQuery as ChildMenuSizeQuery;
...
abstract class MenuPossibleSize implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Models\\ORM\\Menu\\Map\\MenuPossibleSizeTableMap';
    ...
    /**
     * Initializes internal state of API\Models\ORM\Menu\Base\MenuPossibleSize object.
     */
    ...
    /**
     * Compares this with another <code>MenuPossibleSize</code> instance.  If
     * <code>obj</code> is an instance of <code>MenuPossibleSize</code>, delegates to
     * <code>equals(MenuPossibleSize)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|MenuPossibleSize The current object, for fluid interface
     */
    ...
    {
        return $this->menu_possible_sizeid;
    }
     ...
     */
    public function setMenuPossibleSizeid($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->menu_possible_sizeid !== $v) {
            $this->menu_possible_sizeid = $v;
            $this->modifiedColumns[MenuPossibleSizeTableMap::COL_MENU_POSSIBLE_SIZEID] = true;
        }

        return $this;
    } // setMenuPossibleSizeid()
    ...
    public function setMenuSizeid($v)
    {
        ...
        if ($this->menu_sizeid !== $v) {
            $this->menu_sizeid = $v;
            $this->modifiedColumns[MenuPossibleSizeTableMap::COL_MENU_SIZEID] = true;
        }
    ...
    public function setMenuid($v)
    {
        ...
        if ($this->menuid !== $v) {
            $this->menuid = $v;
            $this->modifiedColumns[MenuPossibleSizeTableMap::COL_MENUID] = true;
        }
    ...
    public function setPrice($v)
    {
        ...
        if ($this->price !== $v) {
            $this->price = $v;
            $this->modifiedColumns[MenuPossibleSizeTableMap::COL_PRICE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MenuPossibleSizeTableMap::translateFieldName('MenuPossibleSizeid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->menu_possible_sizeid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MenuPossibleSizeTableMap::translateFieldName('MenuSizeid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->menu_sizeid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : MenuPossibleSizeTableMap::translateFieldName('Menuid', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildMenuPossibleSizeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see MenuPossibleSize::setDeleted()
     * @see MenuPossibleSize::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildMenuPossibleSizeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MenuPossibleSizeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[MenuPossibleSizeTableMap::COL_MENU_POSSIBLE_SIZEID] = true;
        if (null !== $this->menu_possible_sizeid) {
    ...
    {
        $pos = MenuPossibleSizeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['MenuPossibleSize'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['MenuPossibleSize'][$this->hashCode()] = true;
        $keys = MenuPossibleSizeTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getMenuPossibleSizeid(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\API\Models\ORM\Menu\MenuPossibleSize
     */
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setMenuPossibleSizeid($value);
                break;
            case 1:
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setMenuPossibleSizeid($arr[$keys[0]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Models\ORM\Menu\MenuPossibleSize The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \API\Models\ORM\Menu\MenuPossibleSize (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Models\ORM\Menu\MenuPossibleSize Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Declares an association between this object and a ChildMenuSize object.
     *
     * @param  ChildMenuSize $v
     * @return $this|\API\Models\ORM\Menu\MenuPossibleSize The current object (for fluent API support)
     * @throws PropelException
     */
    public function setMenuSize(ChildMenuSize $v = null)
    {
        if ($v === null) {
        ...
        // If this object has already been added to the ChildMenuSize object, it will not be re-added.
        if ($v !== null) {
            $v->addMenuPossibleSize($this);
        }
    ...
    /**
     * Get the associated ChildMenuSize object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildMenuSize The associated ChildMenuSize object.
     * @throws PropelException
     */
    public function getMenuSize(ConnectionInterface $con = null)
    {
        if ($this->aMenuSize === null && ($this->menu_sizeid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aMenuSize->addMenuPossibleSizes($this);
             */
        }
    ...
    public function getMenu(ConnectionInterface $con = null)
    {
        if ($this->aMenu === null && ($this->menuid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aMenu->addMenuPossibleSizes($this);
             */
        }
    ...
    {
        if (null !== $this->aMenuSize) {
            $this->aMenuSize->removeMenuPossibleSize($this);
        }
        if (null !== $this->aMenu) {
            $this->aMenu->removeMenuPossibleSize($this);
        }
        $this->menu_possible_sizeid = null;
    ...
    {
        return (string) $this->exportTo(MenuPossibleSizeTableMap::DEFAULT_STRING_FORMAT);
    }
