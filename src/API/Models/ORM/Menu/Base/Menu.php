...
use API\Models\ORM\Ordering\Base\OrderDetailMixedWith as BaseOrderDetailMixedWith;
...
abstract class Menu implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Models\\ORM\\Menu\\Map\\MenuTableMap';
    ...
    /**
     * Initializes internal state of API\Models\ORM\Menu\Base\Menu object.
     */
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->menuPossibleSizesScheduledForDeletion !== null) {
                if (!$this->menuPossibleSizesScheduledForDeletion->isEmpty()) {
                    \API\Models\ORM\Menu\MenuPossibleSizeQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\API\Models\ORM\Menu\Menu
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Models\ORM\Menu\Menu The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \API\Models\ORM\Menu\Menu (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Models\ORM\Menu\Menu Clone of current object.
     * @throws PropelException
     */
    ...
    public function initMenuPossibleSizes($overrideExisting = true)
    {
        ...
        $this->collMenuPossibleSizes->setModel('\API\Models\ORM\Menu\MenuPossibleSize');
    }
