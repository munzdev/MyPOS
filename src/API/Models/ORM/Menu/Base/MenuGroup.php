...
use API\Models\ORM\DistributionPlace\Base\DistributionPlaceGroup as BaseDistributionPlaceGroup;
...
abstract class MenuGroup implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Models\\ORM\\Menu\\Map\\MenuGroupTableMap';
    ...
    /**
     * Initializes internal state of API\Models\ORM\Menu\Base\MenuGroup object.
     */
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->menusScheduledForDeletion !== null) {
                if (!$this->menusScheduledForDeletion->isEmpty()) {
                    \API\Models\ORM\Menu\MenuQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\API\Models\ORM\Menu\MenuGroup
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Models\ORM\Menu\MenuGroup The current object, for fluid interface
     */
    ...
    {
        return null === $this->getMenuGroupid();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \API\Models\ORM\Menu\MenuGroup (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Models\ORM\Menu\MenuGroup Clone of current object.
     * @throws PropelException
     */
    ...
    public function getMenuType(ConnectionInterface $con = null)
    {
        if ($this->aMenuType === null && ($this->menu_typeid !== null)) {
            $this->aMenuType = ChildMenuTypeQuery::create()->findPk($this->menu_typeid, $con);
    ...
    public function initMenus($overrideExisting = true)
    {
        ...
        $this->collMenus->setModel('\API\Models\ORM\Menu\Menu');
    }
