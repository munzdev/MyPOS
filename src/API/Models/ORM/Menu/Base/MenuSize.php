...
abstract class MenuSize implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Models\\ORM\\Menu\\Map\\MenuSizeTableMap';
    ...
    /**
     * Initializes internal state of API\Models\ORM\Menu\Base\MenuSize object.
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\API\Models\ORM\Menu\MenuSize
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Models\ORM\Menu\MenuSize The current object, for fluid interface
     */
    ...
    /**
     * Generic method to set the primary key (menu_sizeid column).
     *
    ...
    {
        return null === $this->getMenuSizeid();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \API\Models\ORM\Menu\MenuSize (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Models\ORM\Menu\MenuSize Clone of current object.
     * @throws PropelException
     */
