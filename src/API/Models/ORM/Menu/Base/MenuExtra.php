...
abstract class MenuExtra implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Models\\ORM\\Menu\\Map\\MenuExtraTableMap';
    ...
    /**
     * Initializes internal state of API\Models\ORM\Menu\Base\MenuExtra object.
     */
    ...
    public function setIsDeleted($v)
    {
        ...
        if ($this->is_deleted !== null || $dt !== null) {
            if ($this->is_deleted === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->is_deleted->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[MenuExtraTableMap::COL_IS_DELETED] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : MenuExtraTableMap::translateFieldName('IsDeleted', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 6; // 6 = MenuExtraTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\API\\Models\\ORM\\Menu\\MenuExtra'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->menuPossibleExtrasScheduledForDeletion !== null) {
                if (!$this->menuPossibleExtrasScheduledForDeletion->isEmpty()) {
                    \API\Models\ORM\Menu\MenuPossibleExtraQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MenuExtraTableMap::COL_IS_DELETED)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\API\Models\ORM\Menu\MenuExtra
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Models\ORM\Menu\MenuExtra The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MenuExtraTableMap::COL_IS_DELETED)) {
            $criteria->add(MenuExtraTableMap::COL_IS_DELETED, $this->is_deleted);
        }
    ...
    /**
     * Generic method to set the primary key (menu_extraid column).
     *
    ...
    {
        return null === $this->getMenuExtraid();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \API\Models\ORM\Menu\MenuExtra (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Models\ORM\Menu\MenuExtra Clone of current object.
     * @throws PropelException
     */
