 ...
 *
 * @method     \API\Models\ORM\Menu\MenuTypeQuery|\API\Models\ORM\DistributionPlace\DistributionPlaceGroupQuery|\API\Models\ORM\Menu\MenuQuery|\API\Models\ORM\Ordering\OrderDetailQuery|\API\Models\ORM\OIP\OrderInProgressQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class MenuGroupQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \API\Models\ORM\Menu\Base\MenuGroupQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\API\\Models\\ORM\\Menu\\MenuGroup', $modelAlias = null)
    {
     ...
     *
     * @param \API\Models\ORM\Menu\MenuType|ObjectCollection $menuType The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
