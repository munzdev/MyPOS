 ...
 *
 * @method     \API\Models\ORM\Menu\MenuExtraQuery|\API\Models\ORM\Menu\MenuQuery|\API\Models\ORM\Ordering\OrderDetailExtraQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class MenuPossibleExtraQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \API\Models\ORM\Menu\Base\MenuPossibleExtraQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\API\\Models\\ORM\\Menu\\MenuPossibleExtra', $modelAlias = null)
    {
     ...
     *
     * @param \API\Models\ORM\Menu\MenuExtra|ObjectCollection $menuExtra The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
