 ...
 * @method     ChildMenuQuery orderByIsDeleted($order = Criteria::ASC) Order by the is_deleted column
 *
 ...
 * @method     ChildMenuQuery groupByIsDeleted() Group by the is_deleted column
 *
 ...
 *
 * @method     \API\Models\ORM\Menu\AvailabilityQuery|\API\Models\ORM\Menu\MenuGroupQuery|\API\Models\ORM\Menu\MenuPossibleExtraQuery|\API\Models\ORM\Menu\MenuPossibleSizeQuery|\API\Models\ORM\Ordering\OrderDetailQuery|\API\Models\ORM\Ordering\OrderDetailMixedWithQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildMenu findOneByIsDeleted(string $is_deleted) Return the first ChildMenu filtered by the is_deleted column *
 ...
 * @method     ChildMenu requireOneByIsDeleted(string $is_deleted) Return the first ChildMenu filtered by the is_deleted column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildMenu[]|ObjectCollection findByIsDeleted(string $is_deleted) Return ChildMenu objects filtered by the is_deleted column
...
abstract class MenuQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \API\Models\ORM\Menu\Base\MenuQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\API\\Models\\ORM\\Menu\\Menu', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `menuid`, `menu_groupid`, `name`, `price`, `availabilityid`, `availability_amount`, `is_deleted` FROM `menu` WHERE `menuid` = :p0';
        try {
    ...
    public function filterByIsDeleted($isDeleted = null, $comparison = null)
    {
        if (is_array($isDeleted)) {
            ...
            if (isset($isDeleted['min'])) {
                $this->addUsingAlias(MenuTableMap::COL_IS_DELETED, $isDeleted['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($isDeleted['max'])) {
                $this->addUsingAlias(MenuTableMap::COL_IS_DELETED, $isDeleted['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(MenuTableMap::COL_IS_DELETED, $isDeleted, $comparison);
    }
    ...
    /**
     * Filter the query by a related \API\Models\ORM\Menu\MenuPossibleExtra object
     *
     * @param \API\Models\ORM\Menu\MenuPossibleExtra|ObjectCollection $menuPossibleExtra the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildMenuQuery The current query, for fluid interface
     */
    ...
    {
        if ($menuPossibleExtra instanceof \API\Models\ORM\Menu\MenuPossibleExtra) {
            return $this
            ...
            throw new PropelException('filterByMenuPossibleExtra() only accepts arguments of type \API\Models\ORM\Menu\MenuPossibleExtra or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \API\Models\ORM\Menu\MenuPossibleExtraQuery A secondary query class using the current class as primary query
     */
    public function useMenuPossibleExtraQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'MenuPossibleExtra', '\API\Models\ORM\Menu\MenuPossibleExtraQuery');
    }

    /**
     * Filter the query by a related \API\Models\ORM\Menu\MenuPossibleSize object
     *
     * @param \API\Models\ORM\Menu\MenuPossibleSize|ObjectCollection $menuPossibleSize the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildMenuQuery The current query, for fluid interface
     */
    ...
    {
        if ($menuPossibleSize instanceof \API\Models\ORM\Menu\MenuPossibleSize) {
            return $this
            ...
            throw new PropelException('filterByMenuPossibleSize() only accepts arguments of type \API\Models\ORM\Menu\MenuPossibleSize or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \API\Models\ORM\Menu\MenuPossibleSizeQuery A secondary query class using the current class as primary query
     */
    public function useMenuPossibleSizeQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'MenuPossibleSize', '\API\Models\ORM\Menu\MenuPossibleSizeQuery');
    }
