...
class EventBankinformationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.ORM.Event.Map.EventBankinformationTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\ORM\\Event\\EventBankinformation';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.ORM.Event.EventBankinformation';
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\ORM\Event\EventBankinformation) { // it's a model object
