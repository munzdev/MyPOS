...
use API\Models\ORM\Invoice\Base\Invoice as BaseInvoice;
...
abstract class EventBankinformation implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Models\\ORM\\Event\\Map\\EventBankinformationTableMap';
    ...
    /**
     * Initializes internal state of API\Models\ORM\Event\Base\EventBankinformation object.
     */
    ...
    /**
     * Compares this with another <code>EventBankinformation</code> instance.  If
     * <code>obj</code> is an instance of <code>EventBankinformation</code>, delegates to
     * <code>equals(EventBankinformation)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|EventBankinformation The current object, for fluid interface
     */
    ...
    public function setEventBankinformationid($v)
    {
        ...
        if ($this->event_bankinformationid !== $v) {
            ...
            $this->modifiedColumns[EventBankinformationTableMap::COL_EVENT_BANKINFORMATIONID] = true;
        }
    ...
    public function setEventid($v)
    {
        ...
        if ($this->eventid !== $v) {
            $this->eventid = $v;
            $this->modifiedColumns[EventBankinformationTableMap::COL_EVENTID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[EventBankinformationTableMap::COL_NAME] = true;
        }
    ...
    public function setIban($v)
    {
        ...
        if ($this->iban !== $v) {
            $this->iban = $v;
            $this->modifiedColumns[EventBankinformationTableMap::COL_IBAN] = true;
        }
    ...
    public function setBic($v)
    {
        ...
        if ($this->bic !== $v) {
            $this->bic = $v;
            $this->modifiedColumns[EventBankinformationTableMap::COL_BIC] = true;
        }
    ...
    public function setActive($v)
    {
        ...
        if ($this->active !== $v) {
            $this->active = $v;
            $this->modifiedColumns[EventBankinformationTableMap::COL_ACTIVE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : EventBankinformationTableMap::translateFieldName('EventBankinformationid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->event_bankinformationid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : EventBankinformationTableMap::translateFieldName('Eventid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->eventid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : EventBankinformationTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : EventBankinformationTableMap::translateFieldName('Iban', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iban = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : EventBankinformationTableMap::translateFieldName('Bic', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bic = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : EventBankinformationTableMap::translateFieldName('Active', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 6; // 6 = EventBankinformationTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\API\\Models\\ORM\\Event\\EventBankinformation'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        if ($con === null) {
            $con = Propel::getServiceContainer()->getReadConnection(EventBankinformationTableMap::DATABASE_NAME);
        }

        // We don't need to alter the object instance pool; we're just modifying this instance
        // already in the pool.

        $dataFetcher = ChildEventBankinformationQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see EventBankinformation::setDeleted()
     * @see EventBankinformation::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildEventBankinformationQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EventBankinformationTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->invoicesScheduledForDeletion !== null) {
                if (!$this->invoicesScheduledForDeletion->isEmpty()) {
                    \API\Models\ORM\Invoice\InvoiceQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[EventBankinformationTableMap::COL_EVENT_BANKINFORMATIONID] = true;
        if (null !== $this->event_bankinformationid) {
        ...
        $this->setEventBankinformationid($pk);
    ...
    {
        $pos = EventBankinformationTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['EventBankinformation'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['EventBankinformation'][$this->hashCode()] = true;
        $keys = EventBankinformationTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getEventBankinformationid(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\API\Models\ORM\Event\EventBankinformation
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setEventBankinformationid($arr[$keys[0]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Models\ORM\Event\EventBankinformation The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EventBankinformationTableMap::COL_EVENT_BANKINFORMATIONID)) {
            $criteria->add(EventBankinformationTableMap::COL_EVENT_BANKINFORMATIONID, $this->event_bankinformationid);
        }
        if ($this->isColumnModified(EventBankinformationTableMap::COL_EVENTID)) {
            $criteria->add(EventBankinformationTableMap::COL_EVENTID, $this->eventid);
        }
        if ($this->isColumnModified(EventBankinformationTableMap::COL_NAME)) {
            $criteria->add(EventBankinformationTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(EventBankinformationTableMap::COL_IBAN)) {
            $criteria->add(EventBankinformationTableMap::COL_IBAN, $this->iban);
        }
        if ($this->isColumnModified(EventBankinformationTableMap::COL_BIC)) {
            $criteria->add(EventBankinformationTableMap::COL_BIC, $this->bic);
        }
        if ($this->isColumnModified(EventBankinformationTableMap::COL_ACTIVE)) {
            $criteria->add(EventBankinformationTableMap::COL_ACTIVE, $this->active);
        }
    ...
    {
        $criteria = ChildEventBankinformationQuery::create();
        $criteria->add(EventBankinformationTableMap::COL_EVENT_BANKINFORMATIONID, $this->event_bankinformationid);
    ...
    {
        $validPk = null !== $this->getEventBankinformationid();
    ...
    /**
     * Generic method to set the primary key (event_bankinformationid column).
     *
    ...
    {
        $this->setEventBankinformationid($key);
    }
    ...
    {
        return null === $this->getEventBankinformationid();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \API\Models\ORM\Event\EventBankinformation (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Models\ORM\Event\EventBankinformation Clone of current object.
     * @throws PropelException
     */
    ...
    public function setEvent(ChildEvent $v = null)
    {
        ...
        if ($v !== null) {
            $v->addEventBankinformation($this);
        }
    ...
    public function getEvent(ConnectionInterface $con = null)
    {
        if ($this->aEvent === null && ($this->eventid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aEvent->addEventBankinformations($this);
             */
        }
    ...
    public function initInvoices($overrideExisting = true)
    {
        ...
        $this->collInvoices->setModel('\API\Models\ORM\Invoice\Invoice');
    }
    ...
    {
        if (null !== $this->aEvent) {
            $this->aEvent->removeEventBankinformation($this);
        }
    ...
    {
        return (string) $this->exportTo(EventBankinformationTableMap::DEFAULT_STRING_FORMAT);
    }
