...
use API\Models\ORM\User\Message\Base\UserMessage as BaseUserMessage;
...
abstract class EventUser implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Models\\ORM\\Event\\Map\\EventUserTableMap';
    ...
    /**
     * Initializes internal state of API\Models\ORM\Event\Base\EventUser object.
     */
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->userMessagesRelatedByToEventUseridScheduledForDeletion !== null) {
                if (!$this->userMessagesRelatedByToEventUseridScheduledForDeletion->isEmpty()) {
                    \API\Models\ORM\User\Message\UserMessageQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\API\Models\ORM\Event\EventUser
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Models\ORM\Event\EventUser The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \API\Models\ORM\Event\EventUser (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Models\ORM\Event\EventUser Clone of current object.
     * @throws PropelException
     */
    ...
    public function initUserMessagesRelatedByFromEventUserid($overrideExisting = true)
    {
        ...
        $this->collUserMessagesRelatedByFromEventUserid->setModel('\API\Models\ORM\User\Message\UserMessage');
    }
    ...
    public function initUserMessagesRelatedByToEventUserid($overrideExisting = true)
    {
        ...
        $this->collUserMessagesRelatedByToEventUserid->setModel('\API\Models\ORM\User\Message\UserMessage');
    }
