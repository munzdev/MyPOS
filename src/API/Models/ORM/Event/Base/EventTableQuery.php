 ...
 *
 * @method     \API\Models\ORM\Event\EventQuery|\API\Models\ORM\DistributionPlace\DistributionPlaceTableQuery|\API\Models\ORM\Ordering\OrderQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class EventTableQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \API\Models\ORM\Event\Base\EventTableQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\API\\Models\\ORM\\Event\\EventTable', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = EventTableTableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key)))) {
    ...
    {
        if ($eventTable) {
            $this->addUsingAlias(EventTableTableMap::COL_EVENT_TABLEID, $eventTable->getEventTableid(), Criteria::NOT_EQUAL);
        }
