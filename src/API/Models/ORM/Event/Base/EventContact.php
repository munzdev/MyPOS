...
abstract class EventContact implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Models\\ORM\\Event\\Map\\EventContactTableMap';
    ...
    /**
     * Initializes internal state of API\Models\ORM\Event\Base\EventContact object.
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\API\\Models\\ORM\\Event\\EventContact'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\API\Models\ORM\Event\EventContact
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Models\ORM\Event\EventContact The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \API\Models\ORM\Event\EventContact (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Models\ORM\Event\EventContact Clone of current object.
     * @throws PropelException
     */
    ...
    public function initInvoicesRelatedByCustomerEventContactid($overrideExisting = true)
    {
        ...
        $this->collInvoicesRelatedByCustomerEventContactid->setModel('\API\Models\ORM\Invoice\Invoice');
    }
    ...
    public function initInvoicesRelatedByEventContactid($overrideExisting = true)
    {
        ...
        $this->collInvoicesRelatedByEventContactid->setModel('\API\Models\ORM\Invoice\Invoice');
    }
