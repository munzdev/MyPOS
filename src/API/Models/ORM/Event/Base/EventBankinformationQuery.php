...
abstract class EventBankinformationQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \API\Models\ORM\Event\Base\EventBankinformationQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\API\\Models\\ORM\\Event\\EventBankinformation', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof ChildEventBankinformationQuery) {
            return $criteria;
        }
        $query = new ChildEventBankinformationQuery();
        if (null !== $modelAlias) {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = EventBankinformationTableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key)))) {
     ...
     *
     * @return ChildEventBankinformation A model object, or null if the key is not found
     */
    ...
    public function filterByEventBankinformationid($eventBankinformationid = null, $comparison = null)
    {
        if (is_array($eventBankinformationid)) {
            ...
            if (isset($eventBankinformationid['min'])) {
                $this->addUsingAlias(EventBankinformationTableMap::COL_EVENT_BANKINFORMATIONID, $eventBankinformationid['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($eventBankinformationid['max'])) {
                $this->addUsingAlias(EventBankinformationTableMap::COL_EVENT_BANKINFORMATIONID, $eventBankinformationid['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(EventBankinformationTableMap::COL_EVENT_BANKINFORMATIONID, $eventBankinformationid, $comparison);
    }
    ...
    public function filterByEventid($eventid = null, $comparison = null)
    {
        if (is_array($eventid)) {
            ...
            if (isset($eventid['min'])) {
                $this->addUsingAlias(EventBankinformationTableMap::COL_EVENTID, $eventid['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($eventid['max'])) {
                $this->addUsingAlias(EventBankinformationTableMap::COL_EVENTID, $eventid['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(EventBankinformationTableMap::COL_EVENTID, $eventid, $comparison);
    }
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(EventBankinformationTableMap::COL_NAME, $name, $comparison);
    }
    ...
    public function filterByIban($iban = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(EventBankinformationTableMap::COL_IBAN, $iban, $comparison);
    }
    ...
    public function filterByBic($bic = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(EventBankinformationTableMap::COL_BIC, $bic, $comparison);
    }
    ...
    public function filterByActive($active = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(EventBankinformationTableMap::COL_ACTIVE, $active, $comparison);
    }
    ...
    public function filterByEvent($event, $comparison = null)
    {
        if ($event instanceof \API\Models\ORM\Event\Event) {
            return $this
                ->addUsingAlias(EventBankinformationTableMap::COL_EVENTID, $event->getEventid(), $comparison);
            ...
            return $this
                ->addUsingAlias(EventBankinformationTableMap::COL_EVENTID, $event->toKeyValue('PrimaryKey', 'Eventid'), $comparison);
        } else {
    ...
    public function filterByInvoice($invoice, $comparison = null)
    {
        if ($invoice instanceof \API\Models\ORM\Invoice\Invoice) {
            return $this
                ->addUsingAlias(EventBankinformationTableMap::COL_EVENT_BANKINFORMATIONID, $invoice->getEventBankinformationid(), $comparison);
     ...
     * @return $this|ChildEventBankinformationQuery The current query, for fluid interface
     */
    public function prune($eventBankinformation = null)
    {
        if ($eventBankinformation) {
            $this->addUsingAlias(EventBankinformationTableMap::COL_EVENT_BANKINFORMATIONID, $eventBankinformation->getEventBankinformationid(), Criteria::NOT_EQUAL);
        }
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $criteria->setDbName(EventBankinformationTableMap::DATABASE_NAME);
