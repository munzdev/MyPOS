 ...
 *
 * @method     \API\Models\ORM\Event\EventQuery|\API\Models\ORM\DistributionPlace\DistributionPlaceUserQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class EventPrinterQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \API\Models\ORM\Event\Base\EventPrinterQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\API\\Models\\ORM\\Event\\EventPrinter', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof ChildEventPrinterQuery) {
            return $criteria;
        }
        $query = new ChildEventPrinterQuery();
        if (null !== $modelAlias) {
     ...
     *
     * @return ChildEventPrinter A model object, or null if the key is not found
     */
    ...
    public function filterByEventPrinterid($eventPrinterid = null, $comparison = null)
    {
        if (is_array($eventPrinterid)) {
            ...
            if (isset($eventPrinterid['min'])) {
                $this->addUsingAlias(EventPrinterTableMap::COL_EVENT_PRINTERID, $eventPrinterid['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($eventPrinterid['max'])) {
                $this->addUsingAlias(EventPrinterTableMap::COL_EVENT_PRINTERID, $eventPrinterid['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(EventPrinterTableMap::COL_EVENT_PRINTERID, $eventPrinterid, $comparison);
    }
    ...
    public function filterByEventid($eventid = null, $comparison = null)
    {
        if (is_array($eventid)) {
            ...
            if (isset($eventid['min'])) {
                $this->addUsingAlias(EventPrinterTableMap::COL_EVENTID, $eventid['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($eventid['max'])) {
                $this->addUsingAlias(EventPrinterTableMap::COL_EVENTID, $eventid['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(EventPrinterTableMap::COL_EVENTID, $eventid, $comparison);
    }
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(EventPrinterTableMap::COL_NAME, $name, $comparison);
    }
    ...
    public function filterByDefault($default = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(EventPrinterTableMap::COL_DEFAULT, $default, $comparison);
    }
    ...
    public function filterByCharactersPerRow($charactersPerRow = null, $comparison = null)
    {
        if (is_array($charactersPerRow)) {
            ...
            if (isset($charactersPerRow['min'])) {
                $this->addUsingAlias(EventPrinterTableMap::COL_CHARACTERS_PER_ROW, $charactersPerRow['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($charactersPerRow['max'])) {
                $this->addUsingAlias(EventPrinterTableMap::COL_CHARACTERS_PER_ROW, $charactersPerRow['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(EventPrinterTableMap::COL_CHARACTERS_PER_ROW, $charactersPerRow, $comparison);
    }
    ...
    public function filterByEvent($event, $comparison = null)
    {
        if ($event instanceof \API\Models\ORM\Event\Event) {
            return $this
                ->addUsingAlias(EventPrinterTableMap::COL_EVENTID, $event->getEventid(), $comparison);
            ...
            return $this
                ->addUsingAlias(EventPrinterTableMap::COL_EVENTID, $event->toKeyValue('PrimaryKey', 'Eventid'), $comparison);
        } else {
    ...
    /**
     * Filter the query by a related \API\Models\ORM\DistributionPlace\DistributionPlaceUser object
     *
     * @param \API\Models\ORM\DistributionPlace\DistributionPlaceUser|ObjectCollection $distributionPlaceUser the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildEventPrinterQuery The current query, for fluid interface
     */
    ...
    {
        if ($distributionPlaceUser instanceof \API\Models\ORM\DistributionPlace\DistributionPlaceUser) {
            return $this
                ->addUsingAlias(EventPrinterTableMap::COL_EVENT_PRINTERID, $distributionPlaceUser->getEventPrinterid(), $comparison);
            ...
            throw new PropelException('filterByDistributionPlaceUser() only accepts arguments of type \API\Models\ORM\DistributionPlace\DistributionPlaceUser or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \API\Models\ORM\DistributionPlace\DistributionPlaceUserQuery A secondary query class using the current class as primary query
     */
    public function useDistributionPlaceUserQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'DistributionPlaceUser', '\API\Models\ORM\DistributionPlace\DistributionPlaceUserQuery');
    }
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $criteria->setDbName(EventPrinterTableMap::DATABASE_NAME);
