...
namespace API\Models\ORM\Payment\Map;
...
class PaymentTypeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.ORM.Payment.Map.PaymentTypeTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\ORM\\Payment\\PaymentType';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.ORM.Payment.PaymentType';
     ...
     */
    const COL_PAYMENT_TYPEID = 'payment_type.payment_typeid';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'payment_type.name';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('PaymentTypeid', 'Name', ),
        self::TYPE_CAMELNAME     => array('paymentTypeid', 'name', ),
        self::TYPE_COLNAME       => array(PaymentTypeTableMap::COL_PAYMENT_TYPEID, PaymentTypeTableMap::COL_NAME, ),
        self::TYPE_FIELDNAME     => array('payment_typeid', 'name', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('PaymentTypeid' => 0, 'Name' => 1, ),
        self::TYPE_CAMELNAME     => array('paymentTypeid' => 0, 'name' => 1, ),
        self::TYPE_COLNAME       => array(PaymentTypeTableMap::COL_PAYMENT_TYPEID => 0, PaymentTypeTableMap::COL_NAME => 1, ),
        self::TYPE_FIELDNAME     => array('payment_typeid' => 0, 'name' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('payment_typeid', 'PaymentTypeid', 'INTEGER', true, null, null);
  ...
  array (
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        return null === $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('PaymentTypeid', TableMap::TYPE_PHPNAME, $indexType)] || is_scalar($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('PaymentTypeid', TableMap::TYPE_PHPNAME, $indexType)]) || is_callable([$row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('PaymentTypeid', TableMap::TYPE_PHPNAME, $indexType)], '__toString']) ? (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('PaymentTypeid', TableMap::TYPE_PHPNAME, $indexType)] : $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('PaymentTypeid', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(PaymentTypeTableMap::COL_PAYMENT_TYPEID);
            $criteria->addSelectColumn(PaymentTypeTableMap::COL_NAME);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\ORM\Payment\PaymentType) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(PaymentTypeTableMap::DATABASE_NAME);
            $criteria->add(PaymentTypeTableMap::COL_PAYMENT_TYPEID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(PaymentTypeTableMap::COL_PAYMENT_TYPEID) && $criteria->keyContainsValue(PaymentTypeTableMap::COL_PAYMENT_TYPEID) ) {
