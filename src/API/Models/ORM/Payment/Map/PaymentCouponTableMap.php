...
class PaymentCouponTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.ORM.Payment.Map.PaymentCouponTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\ORM\\Payment\\PaymentCoupon';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.ORM.Payment.PaymentCoupon';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\API\\Models\\ORM\\Payment\\PaymentCoupon');
    ...
    {
        $this->addRelation('Coupon', '\\API\\Models\\ORM\\Payment\\Coupon', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':couponid',
    1 => ':couponid',
        ...
        $this->addRelation('PaymentRecieved', '\\API\\Models\\ORM\\Payment\\PaymentRecieved', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
     ...
     * and findPk*() calls.
     *
     * @param \API\Models\ORM\Payment\PaymentCoupon $obj A \API\Models\ORM\Payment\PaymentCoupon object.
     ...
     *
     * @param mixed $value A \API\Models\ORM\Payment\PaymentCoupon object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \API\Models\ORM\Payment\PaymentCoupon) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \API\Models\ORM\Payment\PaymentCoupon object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\ORM\Payment\PaymentCoupon) { // it's a model object
