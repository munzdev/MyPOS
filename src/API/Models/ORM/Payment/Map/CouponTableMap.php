...
class CouponTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.ORM.Payment.Map.CouponTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\ORM\\Payment\\Coupon';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.ORM.Payment.Coupon';
  ...
  array (
    ...
    1 => ':couponid',
        ...
        $this->addRelation('PaymentRecieved', '\\API\\Models\\ORM\\Payment\\PaymentRecieved', RelationMap::MANY_TO_MANY, array(), null, null, 'PaymentRecieveds');
    } // buildRelations()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\ORM\Payment\Coupon) { // it's a model object
