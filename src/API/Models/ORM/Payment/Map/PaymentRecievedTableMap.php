...
class PaymentRecievedTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.ORM.Payment.Map.PaymentRecievedTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\ORM\\Payment\\PaymentRecieved';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.ORM.Payment.PaymentRecieved';
  ...
  array (
    ...
    1 => ':invoiceid',
        ...
        $this->addRelation('PaymentType', '\\API\\Models\\ORM\\Payment\\PaymentType', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':payment_typeid',
    1 => ':payment_typeid',
  ...
  array (
    ...
    1 => ':userid',
        ...
        $this->addRelation('PaymentCoupon', '\\API\\Models\\ORM\\Payment\\PaymentCoupon', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    ...
    1 => ':payment_recievedid',
        ...
        $this->addRelation('Coupon', '\\API\\Models\\ORM\\Payment\\Coupon', RelationMap::MANY_TO_MANY, array(), null, null, 'Coupons');
    } // buildRelations()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\ORM\Payment\PaymentRecieved) { // it's a model object
