 ...
 *
 * @method     \API\Models\ORM\Invoice\InvoiceQuery|\API\Models\ORM\Payment\PaymentTypeQuery|\API\Models\ORM\User\UserQuery|\API\Models\ORM\Payment\PaymentCouponQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class PaymentRecievedQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \API\Models\ORM\Payment\Base\PaymentRecievedQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\API\\Models\\ORM\\Payment\\PaymentRecieved', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \API\Models\ORM\Payment\PaymentType object
     *
     * @param \API\Models\ORM\Payment\PaymentType|ObjectCollection $paymentType The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($paymentType instanceof \API\Models\ORM\Payment\PaymentType) {
            return $this
            ...
            throw new PropelException('filterByPaymentType() only accepts arguments of type \API\Models\ORM\Payment\PaymentType or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \API\Models\ORM\Payment\PaymentTypeQuery A secondary query class using the current class as primary query
     */
    public function usePaymentTypeQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'PaymentType', '\API\Models\ORM\Payment\PaymentTypeQuery');
    }
    ...
    /**
     * Filter the query by a related \API\Models\ORM\Payment\PaymentCoupon object
     *
     * @param \API\Models\ORM\Payment\PaymentCoupon|ObjectCollection $paymentCoupon the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildPaymentRecievedQuery The current query, for fluid interface
     */
    ...
    {
        if ($paymentCoupon instanceof \API\Models\ORM\Payment\PaymentCoupon) {
            return $this
            ...
            throw new PropelException('filterByPaymentCoupon() only accepts arguments of type \API\Models\ORM\Payment\PaymentCoupon or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \API\Models\ORM\Payment\PaymentCouponQuery A secondary query class using the current class as primary query
     */
    public function usePaymentCouponQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'PaymentCoupon', '\API\Models\ORM\Payment\PaymentCouponQuery');
    }
