...
abstract class PaymentCoupon implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Models\\ORM\\Payment\\Map\\PaymentCouponTableMap';
    ...
    /**
     * Initializes internal state of API\Models\ORM\Payment\Base\PaymentCoupon object.
     */
    ...
    /**
     * Compares this with another <code>PaymentCoupon</code> instance.  If
     * <code>obj</code> is an instance of <code>PaymentCoupon</code>, delegates to
     * <code>equals(PaymentCoupon)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|PaymentCoupon The current object, for fluid interface
     */
    ...
    public function setCouponid($v)
    {
        ...
        if ($this->couponid !== $v) {
            $this->couponid = $v;
            $this->modifiedColumns[PaymentCouponTableMap::COL_COUPONID] = true;
        }

        if ($this->aCoupon !== null && $this->aCoupon->getCouponid() !== $v) {
            $this->aCoupon = null;
        }
    ...
    public function setValueUsed($v)
    {
        ...
        if ($this->value_used !== $v) {
            $this->value_used = $v;
            $this->modifiedColumns[PaymentCouponTableMap::COL_VALUE_USED] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 3; // 3 = PaymentCouponTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\API\\Models\\ORM\\Payment\\PaymentCoupon'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPaymentCouponQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see PaymentCoupon::setDeleted()
     * @see PaymentCoupon::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPaymentCouponQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PaymentCouponTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    {
        $pos = PaymentCouponTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['PaymentCoupon'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PaymentCoupon'][$this->hashCode()] = true;
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\API\Models\ORM\Payment\PaymentCoupon
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Models\ORM\Payment\PaymentCoupon The current object, for fluid interface
     */
    ...
    public function hashCode()
    {
        ...
        //relation fk_Coupons_has_payments_Coupons1 to table coupon
        if ($this->aCoupon && $hash = spl_object_hash($this->aCoupon)) {
            $primaryKeyFKs[] = $hash;
        } else {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \API\Models\ORM\Payment\PaymentCoupon (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Models\ORM\Payment\PaymentCoupon Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCoupon(ConnectionInterface $con = null)
    {
        if ($this->aCoupon === null && ($this->couponid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCoupon->addPaymentCoupons($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(PaymentCouponTableMap::DEFAULT_STRING_FORMAT);
    }
