 ...
 *
 * @method     \API\Models\ORM\Event\EventQuery|\API\Models\ORM\User\UserQuery|\API\Models\ORM\Payment\PaymentCouponQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class CouponQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \API\Models\ORM\Payment\Base\CouponQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\API\\Models\\ORM\\Payment\\Coupon', $modelAlias = null)
    {
