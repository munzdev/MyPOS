 ...
 *
 * @method     \API\Models\ORM\Payment\CouponQuery|\API\Models\ORM\Payment\PaymentRecievedQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class PaymentCouponQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \API\Models\ORM\Payment\Base\PaymentCouponQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\API\\Models\\ORM\\Payment\\PaymentCoupon', $modelAlias = null)
    {
     ...
     *
     * @param \API\Models\ORM\Payment\Coupon|ObjectCollection $coupon The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
     ...
     *
     * @param \API\Models\ORM\Payment\PaymentRecieved|ObjectCollection $paymentRecieved The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
