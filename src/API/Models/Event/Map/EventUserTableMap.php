...
class EventUserTableMap extends TableMap
{
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation(
            'UserMessageRelatedByFromEventUserid',
            '\\API\\Models\\User\\Message\\UserMessage',
            ...
            null,
            null,
            'UserMessagesRelatedByFromEventUserid',
            false
        );
        $this->addRelation(
            'UserMessageRelatedByToEventUserid',
            '\\API\\Models\\User\\Message\\UserMessage',
            RelationMap::ONE_TO_MANY,
            array(
            0 =>
            ...
            null,
            null,
            'UserMessagesRelatedByToEventUserid',
            false
        );
    } // buildRelations()
