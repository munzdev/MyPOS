...
class EventContactTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.Event.Map.EventContactTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\Event\\EventContact';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.Event.EventContact';
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\Event\EventContact) { // it's a model object
