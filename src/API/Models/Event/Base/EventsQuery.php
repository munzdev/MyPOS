 ...
 *
 * @method     \API\Models\Payment\CouponsQuery|\API\Models\DistributionPlace\DistributionsPlacesQuery|\API\Models\Event\EventsPrintersQuery|\API\Models\Event\EventsTablesQuery|\API\Models\Event\EventsUserQuery|\API\Models\Menues\MenuExtrasQuery|\API\Models\Menues\MenuSizesQuery|\API\Models\Menues\MenuTypesQuery|\API\Models\Ordering\OrdersQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class EventsQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \API\Models\Event\Base\EventsQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\API\\Models\\Event\\Events', $modelAlias = null)
    {
     ...
     *
     * @param \API\Models\DistributionPlace\DistributionsPlaces|ObjectCollection $distributionsPlaces the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildEventsQuery The current query, for fluid interface
     */
     ...
     *
     * @param \API\Models\Event\EventsPrinters|ObjectCollection $eventsPrinters the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildEventsQuery The current query, for fluid interface
     */
     ...
     *
     * @param \API\Models\Event\EventsTables|ObjectCollection $eventsTables the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildEventsQuery The current query, for fluid interface
     */
    ...
    /**
     * Filter the query by a related \API\Models\Menues\MenuExtras object
     *
     * @param \API\Models\Menues\MenuExtras|ObjectCollection $menuExtras the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildEventsQuery The current query, for fluid interface
     */
    ...
    {
        if ($menuExtras instanceof \API\Models\Menues\MenuExtras) {
            return $this
            ...
            throw new PropelException('filterByMenuExtras() only accepts arguments of type \API\Models\Menues\MenuExtras or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \API\Models\Menues\MenuExtrasQuery A secondary query class using the current class as primary query
     */
    public function useMenuExtrasQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinMenuExtras($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'MenuExtras', '\API\Models\Menues\MenuExtrasQuery');
    }

    /**
     * Filter the query by a related \API\Models\Menues\MenuSizes object
     *
     * @param \API\Models\Menues\MenuSizes|ObjectCollection $menuSizes the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildEventsQuery The current query, for fluid interface
     */
    ...
    /**
     * Filter the query by a related \API\Models\Menues\MenuTypes object
     *
     * @param \API\Models\Menues\MenuTypes|ObjectCollection $menuTypes the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildEventsQuery The current query, for fluid interface
     */
    ...
    {
        if ($menuTypes instanceof \API\Models\Menues\MenuTypes) {
            return $this
            ...
            throw new PropelException('filterByMenuTypes() only accepts arguments of type \API\Models\Menues\MenuTypes or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \API\Models\Menues\MenuTypesQuery A secondary query class using the current class as primary query
     */
    public function useMenuTypesQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinMenuTypes($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'MenuTypes', '\API\Models\Menues\MenuTypesQuery');
    }
