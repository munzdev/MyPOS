...
abstract class EventContactQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \API\Models\Event\Base\EventContactQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\API\\Models\\Event\\EventContact', $modelAlias = null)
    {
    ...
    public function filterByInvoiceRelatedByEventContactid($invoice, $comparison = null)
    {
        if ($invoice instanceof \API\Models\Invoice\Invoice) {
            ...
            throw new PropelException('filterByInvoiceRelatedByEventContactid() only accepts arguments of type \API\Models\Invoice\Invoice or Collection');
        }
    }
    ...
    public function useInvoiceRelatedByEventContactidQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'InvoiceRelatedByEventContactid', '\API\Models\Invoice\InvoiceQuery');
    }
