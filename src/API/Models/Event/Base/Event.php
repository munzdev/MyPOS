...
use API\Models\Menu\Base\MenuExtra as BaseMenuExtra;
...
abstract class Event implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Models\\Event\\Map\\EventTableMap';
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\API\\Models\\Event\\Event'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->distributionPlacesScheduledForDeletion !== null) {
                if (!$this->distributionPlacesScheduledForDeletion->isEmpty()) {
                    \API\Models\DistributionPlace\DistributionPlaceQuery::create()
            ...
            if ($this->eventPrintersScheduledForDeletion !== null) {
                if (!$this->eventPrintersScheduledForDeletion->isEmpty()) {
                    \API\Models\Event\EventPrinterQuery::create()
            ...
            if ($this->eventTablesScheduledForDeletion !== null) {
                if (!$this->eventTablesScheduledForDeletion->isEmpty()) {
                    \API\Models\Event\EventTableQuery::create()
            ...
            if ($this->menuSizesScheduledForDeletion !== null) {
                if (!$this->menuSizesScheduledForDeletion->isEmpty()) {
                    \API\Models\Menu\MenuSizeQuery::create()
            ...
            if ($this->menuTypesScheduledForDeletion !== null) {
                if (!$this->menuTypesScheduledForDeletion->isEmpty()) {
                    \API\Models\Menu\MenuTypeQuery::create()
            ...
            if ($this->invoiceWarningTypesScheduledForDeletion !== null) {
                if (!$this->invoiceWarningTypesScheduledForDeletion->isEmpty()) {
                    \API\Models\Invoice\InvoiceWarningTypeQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\API\Models\Event\Event
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Models\Event\Event The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \API\Models\Event\Event (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Models\Event\Event Clone of current object.
     * @throws PropelException
     */
    ...
    public function initEventPrinters($overrideExisting = true)
    {
        ...
        $this->collEventPrinters->setModel('\API\Models\Event\EventPrinter');
    }
    ...
    public function initMenuSizes($overrideExisting = true)
    {
        ...
        $this->collMenuSizes->setModel('\API\Models\Menu\MenuSize');
    }
    ...
    public function initMenuTypes($overrideExisting = true)
    {
        ...
        $this->collMenuTypes->setModel('\API\Models\Menu\MenuType');
    }
    ...
    public function initInvoiceWarningTypes($overrideExisting = true)
    {
        ...
        $this->collInvoiceWarningTypes->setModel('\API\Models\Invoice\InvoiceWarningType');
    }
