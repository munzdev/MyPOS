 ...
 *
 * @method     \API\Models\Event\EventsQuery|\API\Models\DistributionPlace\DistributionsPlacesUsersQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class EventsPrintersQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \API\Models\Event\Base\EventsPrintersQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\API\\Models\\Event\\EventsPrinters', $modelAlias = null)
    {
