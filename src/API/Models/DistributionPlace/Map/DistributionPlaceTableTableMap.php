...
class DistributionPlaceTableTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.DistributionPlace.Map.DistributionPlaceTableTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\DistributionPlace\\DistributionPlaceTable';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.DistributionPlace.DistributionPlaceTable';
    ...
    public function buildRelations()
    {
        $this->addRelation(
            ...
            '\\API\\Models\\DistributionPlace\\DistributionPlaceGroup',
     ...
     * and findPk*() calls.
     *
     * @param \API\Models\DistributionPlace\DistributionPlaceTable $obj A \API\Models\DistributionPlace\DistributionPlaceTable object.
     ...
     *
     * @param mixed $value A \API\Models\DistributionPlace\DistributionPlaceTable object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \API\Models\DistributionPlace\DistributionPlaceTable) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \API\Models\DistributionPlace\DistributionPlaceTable object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
...
*/
    ...
    public static function doDelete($values, ConnectionInterface $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\DistributionPlace\DistributionPlaceTable) { // it's a model object
