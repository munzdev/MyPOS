...
class DistributionsPlacesUsersTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.DistributionPlace.Map.DistributionsPlacesUsersTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\DistributionPlace\\DistributionsPlacesUsers';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.DistributionPlace.DistributionsPlacesUsers';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\API\\Models\\DistributionPlace\\DistributionsPlacesUsers');
  ...
  array (
    ...
    1 => ':userid',
        ...
        $this->addRelation('EventsPrinters', '\\API\\Models\\Event\\EventsPrinters', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':events_printerid',
    1 => ':events_printerid',
     ...
     * and findPk*() calls.
     *
     * @param \API\Models\DistributionPlace\DistributionsPlacesUsers $obj A \API\Models\DistributionPlace\DistributionsPlacesUsers object.
     ...
     *
     * @param mixed $value A \API\Models\DistributionPlace\DistributionsPlacesUsers object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \API\Models\DistributionPlace\DistributionsPlacesUsers) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \API\Models\DistributionPlace\DistributionsPlacesUsers object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\DistributionPlace\DistributionsPlacesUsers) { // it's a model object
