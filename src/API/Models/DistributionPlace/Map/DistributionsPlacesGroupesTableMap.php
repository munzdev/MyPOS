...
class DistributionsPlacesGroupesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.DistributionPlace.Map.DistributionsPlacesGroupesTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\DistributionPlace\\DistributionsPlacesGroupes';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.DistributionPlace.DistributionsPlacesGroupes';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\API\\Models\\DistributionPlace\\DistributionsPlacesGroupes');
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \API\Models\DistributionPlace\DistributionsPlacesGroupes $obj A \API\Models\DistributionPlace\DistributionsPlacesGroupes object.
     ...
     *
     * @param mixed $value A \API\Models\DistributionPlace\DistributionsPlacesGroupes object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \API\Models\DistributionPlace\DistributionsPlacesGroupes) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \API\Models\DistributionPlace\DistributionsPlacesGroupes object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\DistributionPlace\DistributionsPlacesGroupes) { // it's a model object
