 ...
 *
 * @method     \API\Models\DistributionPlace\DistributionsPlacesQuery|\API\Models\Menues\MenuGroupesQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class DistributionsPlacesGroupesQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \API\Models\DistributionPlace\Base\DistributionsPlacesGroupesQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\API\\Models\\DistributionPlace\\DistributionsPlacesGroupes', $modelAlias = null)
    {
