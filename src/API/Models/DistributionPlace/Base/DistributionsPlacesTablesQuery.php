 ...
 *
 * @method     \API\Models\Menues\MenuGroupesQuery|\API\Models\DistributionPlace\DistributionsPlacesQuery|\API\Models\Event\EventsTablesQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class DistributionsPlacesTablesQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \API\Models\DistributionPlace\Base\DistributionsPlacesTablesQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\API\\Models\\DistributionPlace\\DistributionsPlacesTables', $modelAlias = null)
    {
