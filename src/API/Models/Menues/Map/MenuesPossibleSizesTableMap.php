...
use API\Models\Menues\MenuesPossibleSizes;
use API\Models\Menues\MenuesPossibleSizesQuery;
...
class MenuesPossibleSizesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.Menues.Map.MenuesPossibleSizesTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\Menues\\MenuesPossibleSizes';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.Menues.MenuesPossibleSizes';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\API\\Models\\Menues\\MenuesPossibleSizes');
    ...
    {
        $this->addRelation('MenuSizes', '\\API\\Models\\Menues\\MenuSizes', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':menu_sizeid',
    1 => ':menu_sizeid',
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \API\Models\Menues\MenuesPossibleSizes $obj A \API\Models\Menues\MenuesPossibleSizes object.
     ...
     *
     * @param mixed $value A \API\Models\Menues\MenuesPossibleSizes object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \API\Models\Menues\MenuesPossibleSizes) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \API\Models\Menues\MenuesPossibleSizes object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\Menues\MenuesPossibleSizes) { // it's a model object
