...
class MenuSizesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.Menues.Map.MenuSizesTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\Menues\\MenuSizes';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.Menues.MenuSizes';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\API\\Models\\Menues\\MenuSizes');
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \API\Models\Menues\MenuSizes $obj A \API\Models\Menues\MenuSizes object.
     ...
     *
     * @param mixed $value A \API\Models\Menues\MenuSizes object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \API\Models\Menues\MenuSizes) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \API\Models\Menues\MenuSizes object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\Menues\MenuSizes) { // it's a model object
