...
class MenuGroupesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.Menues.Map.MenuGroupesTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\Menues\\MenuGroupes';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.Menues.MenuGroupes';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\API\\Models\\Menues\\MenuGroupes');
    ...
    {
        $this->addRelation('MenuTypes', '\\API\\Models\\Menues\\MenuTypes', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':menu_typeid',
    1 => ':menu_typeid',
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \API\Models\Menues\MenuGroupes $obj A \API\Models\Menues\MenuGroupes object.
     ...
     *
     * @param mixed $value A \API\Models\Menues\MenuGroupes object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \API\Models\Menues\MenuGroupes) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \API\Models\Menues\MenuGroupes object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\Menues\MenuGroupes) { // it's a model object
