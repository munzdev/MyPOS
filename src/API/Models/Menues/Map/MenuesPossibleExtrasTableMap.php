...
class MenuesPossibleExtrasTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.Menues.Map.MenuesPossibleExtrasTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\Menues\\MenuesPossibleExtras';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.Menues.MenuesPossibleExtras';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\API\\Models\\Menues\\MenuesPossibleExtras');
    ...
    {
        $this->addRelation('MenuExtras', '\\API\\Models\\Menues\\MenuExtras', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':menu_extraid',
    1 => ':menu_extraid',
  ...
  array (
    ...
    1 => ':menuid',
        ...
        $this->addRelation('OrdersDetailExtras', '\\API\\Models\\Ordering\\OrdersDetailExtras', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
     ...
     * and findPk*() calls.
     *
     * @param \API\Models\Menues\MenuesPossibleExtras $obj A \API\Models\Menues\MenuesPossibleExtras object.
     ...
     *
     * @param mixed $value A \API\Models\Menues\MenuesPossibleExtras object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \API\Models\Menues\MenuesPossibleExtras) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \API\Models\Menues\MenuesPossibleExtras object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\Menues\MenuesPossibleExtras) { // it's a model object
