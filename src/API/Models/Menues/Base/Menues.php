...
use API\Models\Menues\Map\MenuesTableMap;
...
use API\Models\Ordering\Base\OrdersDetailsMixedWith as BaseOrdersDetailsMixedWith;
...
abstract class Menues implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Models\\Menues\\Map\\MenuesTableMap';
    ...
    /**
     * Initializes internal state of API\Models\Menues\Base\Menues object.
     */
     ...
     * @return $this|\API\Models\Menues\Menues The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\API\\Models\\Menues\\Menues'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->ordersDetailsMixedWithsScheduledForDeletion !== null) {
                if (!$this->ordersDetailsMixedWithsScheduledForDeletion->isEmpty()) {
                    \API\Models\Ordering\OrdersDetailsMixedWithQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\API\Models\Menues\Menues
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Models\Menues\Menues The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \API\Models\Menues\Menues (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Models\Menues\Menues Clone of current object.
     * @throws PropelException
     */
    ...
    public function initOrdersDetailsMixedWiths($overrideExisting = true)
    {
        ...
        $this->collOrdersDetailsMixedWiths->setModel('\API\Models\Ordering\OrdersDetailsMixedWith');
    }
