 ...
 *
 * @method     \API\Models\Menues\MenuTypesQuery|\API\Models\DistributionPlace\DistributionsPlacesGroupesQuery|\API\Models\DistributionPlace\DistributionsPlacesTablesQuery|\API\Models\Menues\MenuesQuery|\API\Models\Ordering\OrdersDetailsQuery|\API\Models\OIP\OrdersInProgressQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class MenuGroupesQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \API\Models\Menues\Base\MenuGroupesQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\API\\Models\\Menues\\MenuGroupes', $modelAlias = null)
    {
     ...
     *
     * @param \API\Models\Menues\MenuTypes|ObjectCollection $menuTypes The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
     ...
     *
     * @param \API\Models\Menues\Menues|ObjectCollection $menues the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildMenuGroupesQuery The current query, for fluid interface
     */
