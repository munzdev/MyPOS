...
use \Exception;
use \PDO;
use API\Models\DistributionPlace\DistributionsPlacesGroupes;
use API\Models\DistributionPlace\DistributionsPlacesGroupesQuery;
...
use API\Models\DistributionPlace\Base\DistributionsPlacesGroupes as BaseDistributionsPlacesGroupes;
...
abstract class MenuGroupes implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Models\\Menues\\Map\\MenuGroupesTableMap';
    ...
    /**
     * Initializes internal state of API\Models\Menues\Base\MenuGroupes object.
     */
     ...
     * @return $this|\API\Models\Menues\MenuGroupes The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\API\\Models\\Menues\\MenuGroupes'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->menuessScheduledForDeletion !== null) {
                if (!$this->menuessScheduledForDeletion->isEmpty()) {
                    \API\Models\Menues\MenuesQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\API\Models\Menues\MenuGroupes
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Models\Menues\MenuGroupes The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \API\Models\Menues\MenuGroupes (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Models\Menues\MenuGroupes Clone of current object.
     * @throws PropelException
     */
    ...
    public function initMenuess($overrideExisting = true)
    {
        ...
        $this->collMenuess->setModel('\API\Models\Menues\Menues');
    }
