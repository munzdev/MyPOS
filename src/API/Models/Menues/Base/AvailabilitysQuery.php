...
use API\Models\Menues\Map\AvailabilitysTableMap;
 ...
 *
 * @method     \API\Models\Menues\MenuExtrasQuery|\API\Models\Menues\MenuesQuery|\API\Models\Ordering\OrdersDetailsQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class AvailabilitysQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \API\Models\Menues\Base\AvailabilitysQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\API\\Models\\Menues\\Availabilitys', $modelAlias = null)
    {
