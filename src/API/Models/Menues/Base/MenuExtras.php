...
use API\Models\Menues\Availabilitys as ChildAvailabilitys;
use API\Models\Menues\AvailabilitysQuery as ChildAvailabilitysQuery;
...
/**
 * Base class that represents a row from the 'menu_extras' table.
 *
 *
 *
 * @package    propel.generator.API.Models.Menues.Base
 */
abstract class MenuExtras implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Models\\Menues\\Map\\MenuExtrasTableMap';
    ...
    /**
     * Initializes internal state of API\Models\Menues\Base\MenuExtras object.
     */
    ...
    /**
     * Compares this with another <code>MenuExtras</code> instance.  If
     * <code>obj</code> is an instance of <code>MenuExtras</code>, delegates to
     * <code>equals(MenuExtras)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|MenuExtras The current object, for fluid interface
     */
     ...
     * @return $this|\API\Models\Menues\MenuExtras The current object (for fluent API support)
     */
    public function setMenuExtraid($v)
    {
        ...
        if ($this->menu_extraid !== $v) {
            $this->menu_extraid = $v;
            $this->modifiedColumns[MenuExtrasTableMap::COL_MENU_EXTRAID] = true;
        }
    ...
    public function setEventid($v)
    {
        ...
        if ($this->eventid !== $v) {
            $this->eventid = $v;
            $this->modifiedColumns[MenuExtrasTableMap::COL_EVENTID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[MenuExtrasTableMap::COL_NAME] = true;
        }
    ...
    public function setAvailabilityid($v)
    {
        ...
        if ($this->availabilityid !== $v) {
            ...
            $this->modifiedColumns[MenuExtrasTableMap::COL_AVAILABILITYID] = true;
        }
    ...
    public function setAvailabilityAmount($v)
    {
        ...
        if ($this->availability_amount !== $v) {
            ...
            $this->modifiedColumns[MenuExtrasTableMap::COL_AVAILABILITY_AMOUNT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MenuExtrasTableMap::translateFieldName('MenuExtraid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->menu_extraid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MenuExtrasTableMap::translateFieldName('Eventid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->eventid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : MenuExtrasTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : MenuExtrasTableMap::translateFieldName('Availabilityid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->availabilityid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : MenuExtrasTableMap::translateFieldName('AvailabilityAmount', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = MenuExtrasTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\API\\Models\\Menues\\MenuExtras'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildMenuExtrasQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see MenuExtras::setDeleted()
     * @see MenuExtras::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildMenuExtrasQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MenuExtrasTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->menuesPossibleExtrassScheduledForDeletion !== null) {
                if (!$this->menuesPossibleExtrassScheduledForDeletion->isEmpty()) {
                    \API\Models\Menues\MenuesPossibleExtrasQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MenuExtrasTableMap::COL_MENU_EXTRAID)) {
            $modifiedColumns[':p' . $index++]  = 'menu_extraid';
        }
        if ($this->isColumnModified(MenuExtrasTableMap::COL_EVENTID)) {
            $modifiedColumns[':p' . $index++]  = 'eventid';
        }
        if ($this->isColumnModified(MenuExtrasTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(MenuExtrasTableMap::COL_AVAILABILITYID)) {
            $modifiedColumns[':p' . $index++]  = 'availabilityid';
        }
        if ($this->isColumnModified(MenuExtrasTableMap::COL_AVAILABILITY_AMOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'availability_amount';
        }

        $sql = sprintf(
            'INSERT INTO menu_extras (%s) VALUES (%s)',
    ...
    {
        $pos = MenuExtrasTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['MenuExtras'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['MenuExtras'][$this->hashCode()] = true;
        $keys = MenuExtrasTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\API\Models\Menues\MenuExtras
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Models\Menues\MenuExtras The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MenuExtrasTableMap::COL_MENU_EXTRAID)) {
            $criteria->add(MenuExtrasTableMap::COL_MENU_EXTRAID, $this->menu_extraid);
        }
        if ($this->isColumnModified(MenuExtrasTableMap::COL_EVENTID)) {
            $criteria->add(MenuExtrasTableMap::COL_EVENTID, $this->eventid);
        }
        if ($this->isColumnModified(MenuExtrasTableMap::COL_NAME)) {
            $criteria->add(MenuExtrasTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(MenuExtrasTableMap::COL_AVAILABILITYID)) {
            $criteria->add(MenuExtrasTableMap::COL_AVAILABILITYID, $this->availabilityid);
        }
        if ($this->isColumnModified(MenuExtrasTableMap::COL_AVAILABILITY_AMOUNT)) {
            $criteria->add(MenuExtrasTableMap::COL_AVAILABILITY_AMOUNT, $this->availability_amount);
        }
    ...
    {
        $criteria = ChildMenuExtrasQuery::create();
        $criteria->add(MenuExtrasTableMap::COL_MENU_EXTRAID, $this->menu_extraid);
        $criteria->add(MenuExtrasTableMap::COL_EVENTID, $this->eventid);
    ...
    public function hashCode()
    {
        ...
        //relation fk_menu_extras_events1 to table events
     ...
     * objects.
     *
     * @param      object $copyObj An object of \API\Models\Menues\MenuExtras (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Models\Menues\MenuExtras Clone of current object.
     * @throws PropelException
     */
    ...
    public function getAvailabilitys(ConnectionInterface $con = null)
    {
        if ($this->aAvailabilitys === null && ($this->availabilityid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aAvailabilitys->addMenuExtrass($this);
             */
        }
    ...
    public function getEvents(ConnectionInterface $con = null)
    {
        if ($this->aEvents === null && ($this->eventid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aEvents->addMenuExtrass($this);
             */
        }
    ...
    public function initMenuesPossibleExtrass($overrideExisting = true)
    {
        ...
        $this->collMenuesPossibleExtrass->setModel('\API\Models\Menues\MenuesPossibleExtras');
    }
     ...
     * If this ChildMenuExtras is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildMenuExtras The current object (for fluent API support)
     */
    public function setMenuesPossibleExtrass(Collection $menuesPossibleExtrass, ConnectionInterface $con = null)
    {
        ...
        foreach ($menuesPossibleExtrassToDelete as $menuesPossibleExtrasRemoved) {
            $menuesPossibleExtrasRemoved->setMenuExtras(null);
        }
    ...
    protected function doAddMenuesPossibleExtras(ChildMenuesPossibleExtras $menuesPossibleExtras)
    {
        ...
        $menuesPossibleExtras->setMenuExtras($this);
    }
    ...
    public function removeMenuesPossibleExtras(ChildMenuesPossibleExtras $menuesPossibleExtras)
    {
        if ($this->getMenuesPossibleExtrass()->contains($menuesPossibleExtras)) {
            ...
            $menuesPossibleExtras->setMenuExtras(null);
        }
     ...
     * Otherwise if this MenuExtras is new, it will return
     * an empty collection; or if this MenuExtras has previously
     * been saved, it will retrieve related MenuesPossibleExtrass from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in MenuExtras.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildMenuesPossibleExtras[] List of ChildMenuesPossibleExtras objects
     */
    public function getMenuesPossibleExtrassJoinMenues(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildMenuesPossibleExtrasQuery::create(null, $criteria);
    ...
    {
        if (null !== $this->aAvailabilitys) {
            $this->aAvailabilitys->removeMenuExtras($this);
        }
        if (null !== $this->aEvents) {
            $this->aEvents->removeMenuExtras($this);
        }
    ...
    {
        return (string) $this->exportTo(MenuExtrasTableMap::DEFAULT_STRING_FORMAT);
    }
