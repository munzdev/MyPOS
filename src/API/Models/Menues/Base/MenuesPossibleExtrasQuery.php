 ...
 *
 * @method     \API\Models\Menues\MenuExtrasQuery|\API\Models\Menues\MenuesQuery|\API\Models\Ordering\OrdersDetailExtrasQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class MenuesPossibleExtrasQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \API\Models\Menues\Base\MenuesPossibleExtrasQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\API\\Models\\Menues\\MenuesPossibleExtras', $modelAlias = null)
    {
     ...
     *
     * @param \API\Models\Menues\MenuExtras|ObjectCollection $menuExtras The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
