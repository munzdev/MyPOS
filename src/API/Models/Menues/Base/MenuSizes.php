...
/**
 * Base class that represents a row from the 'menu_sizes' table.
 *
 *
 *
 * @package    propel.generator.API.Models.Menues.Base
 */
abstract class MenuSizes implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Models\\Menues\\Map\\MenuSizesTableMap';
    ...
    /**
     * Initializes internal state of API\Models\Menues\Base\MenuSizes object.
     */
    ...
    /**
     * Compares this with another <code>MenuSizes</code> instance.  If
     * <code>obj</code> is an instance of <code>MenuSizes</code>, delegates to
     * <code>equals(MenuSizes)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|MenuSizes The current object, for fluid interface
     */
     ...
     * @return $this|\API\Models\Menues\MenuSizes The current object (for fluent API support)
     */
    public function setMenuSizeid($v)
    {
        ...
        if ($this->menu_sizeid !== $v) {
            $this->menu_sizeid = $v;
            $this->modifiedColumns[MenuSizesTableMap::COL_MENU_SIZEID] = true;
        }
    ...
    public function setEventid($v)
    {
        ...
        if ($this->eventid !== $v) {
            $this->eventid = $v;
            $this->modifiedColumns[MenuSizesTableMap::COL_EVENTID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[MenuSizesTableMap::COL_NAME] = true;
        }
    ...
    public function setFactor($v)
    {
        ...
        if ($this->factor !== $v) {
            $this->factor = $v;
            $this->modifiedColumns[MenuSizesTableMap::COL_FACTOR] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MenuSizesTableMap::translateFieldName('MenuSizeid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->menu_sizeid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MenuSizesTableMap::translateFieldName('Eventid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->eventid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : MenuSizesTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : MenuSizesTableMap::translateFieldName('Factor', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = MenuSizesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\API\\Models\\Menues\\MenuSizes'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildMenuSizesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see MenuSizes::setDeleted()
     * @see MenuSizes::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildMenuSizesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MenuSizesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->menuesPossibleSizessScheduledForDeletion !== null) {
                if (!$this->menuesPossibleSizessScheduledForDeletion->isEmpty()) {
                    \API\Models\Menues\MenuesPossibleSizesQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MenuSizesTableMap::COL_MENU_SIZEID)) {
            $modifiedColumns[':p' . $index++]  = 'menu_sizeid';
        }
        if ($this->isColumnModified(MenuSizesTableMap::COL_EVENTID)) {
            $modifiedColumns[':p' . $index++]  = 'eventid';
        }
        if ($this->isColumnModified(MenuSizesTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(MenuSizesTableMap::COL_FACTOR)) {
            $modifiedColumns[':p' . $index++]  = 'factor';
        }

        $sql = sprintf(
            'INSERT INTO menu_sizes (%s) VALUES (%s)',
    ...
    {
        $pos = MenuSizesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['MenuSizes'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['MenuSizes'][$this->hashCode()] = true;
        $keys = MenuSizesTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\API\Models\Menues\MenuSizes
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Models\Menues\MenuSizes The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MenuSizesTableMap::COL_MENU_SIZEID)) {
            $criteria->add(MenuSizesTableMap::COL_MENU_SIZEID, $this->menu_sizeid);
        }
        if ($this->isColumnModified(MenuSizesTableMap::COL_EVENTID)) {
            $criteria->add(MenuSizesTableMap::COL_EVENTID, $this->eventid);
        }
        if ($this->isColumnModified(MenuSizesTableMap::COL_NAME)) {
            $criteria->add(MenuSizesTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(MenuSizesTableMap::COL_FACTOR)) {
            $criteria->add(MenuSizesTableMap::COL_FACTOR, $this->factor);
        }
    ...
    {
        $criteria = ChildMenuSizesQuery::create();
        $criteria->add(MenuSizesTableMap::COL_MENU_SIZEID, $this->menu_sizeid);
        $criteria->add(MenuSizesTableMap::COL_EVENTID, $this->eventid);
    ...
    public function hashCode()
    {
        ...
        //relation fk_menu_sizes_events1 to table events
     ...
     * objects.
     *
     * @param      object $copyObj An object of \API\Models\Menues\MenuSizes (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Models\Menues\MenuSizes Clone of current object.
     * @throws PropelException
     */
    ...
    public function getEvents(ConnectionInterface $con = null)
    {
        if ($this->aEvents === null && ($this->eventid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aEvents->addMenuSizess($this);
             */
        }
    ...
    public function initMenuesPossibleSizess($overrideExisting = true)
    {
        ...
        $this->collMenuesPossibleSizess->setModel('\API\Models\Menues\MenuesPossibleSizes');
    }
     ...
     * If this ChildMenuSizes is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildMenuSizes The current object (for fluent API support)
     */
    public function setMenuesPossibleSizess(Collection $menuesPossibleSizess, ConnectionInterface $con = null)
    {
        ...
        foreach ($menuesPossibleSizessToDelete as $menuesPossibleSizesRemoved) {
            $menuesPossibleSizesRemoved->setMenuSizes(null);
        }
    ...
    protected function doAddMenuesPossibleSizes(ChildMenuesPossibleSizes $menuesPossibleSizes)
    {
        ...
        $menuesPossibleSizes->setMenuSizes($this);
    }
    ...
    public function removeMenuesPossibleSizes(ChildMenuesPossibleSizes $menuesPossibleSizes)
    {
        if ($this->getMenuesPossibleSizess()->contains($menuesPossibleSizes)) {
            ...
            $menuesPossibleSizes->setMenuSizes(null);
        }
     ...
     * Otherwise if this MenuSizes is new, it will return
     * an empty collection; or if this MenuSizes has previously
     * been saved, it will retrieve related MenuesPossibleSizess from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in MenuSizes.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildMenuesPossibleSizes[] List of ChildMenuesPossibleSizes objects
     */
    public function getMenuesPossibleSizessJoinMenues(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildMenuesPossibleSizesQuery::create(null, $criteria);
    ...
    public function setOrdersDetailss(Collection $ordersDetailss, ConnectionInterface $con = null)
    {
        ...
        foreach ($ordersDetailssToDelete as $ordersDetailsRemoved) {
            $ordersDetailsRemoved->setMenuSizes(null);
        }
    ...
    protected function doAddOrdersDetails(OrdersDetails $ordersDetails)
    {
        ...
        $ordersDetails->setMenuSizes($this);
    }
    ...
    public function removeOrdersDetails(OrdersDetails $ordersDetails)
    {
        if ($this->getOrdersDetailss()->contains($ordersDetails)) {
            ...
            $ordersDetails->setMenuSizes(null);
        }
    ...
    {
        if (null !== $this->aEvents) {
            $this->aEvents->removeMenuSizes($this);
        }
    ...
    {
        return (string) $this->exportTo(MenuSizesTableMap::DEFAULT_STRING_FORMAT);
    }
