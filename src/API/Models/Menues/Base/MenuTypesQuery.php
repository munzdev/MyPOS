 ...
 *
 * @method     \API\Models\Event\EventsQuery|\API\Models\Menues\MenuGroupesQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class MenuTypesQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \API\Models\Menues\Base\MenuTypesQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\API\\Models\\Menues\\MenuTypes', $modelAlias = null)
    {
     ...
     *
     * @param \API\Models\Menues\MenuGroupes|ObjectCollection $menuGroupes the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildMenuTypesQuery The current query, for fluid interface
     */
