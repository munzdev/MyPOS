...
use API\Models\OIP\OrderInProgressRecieved as ChildOrderInProgressRecieved;
...
abstract class DistributionGivingOut implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Models\\OIP\\Map\\DistributionGivingOutTableMap';
    ...
    /**
     * Initializes internal state of API\Models\OIP\Base\DistributionGivingOut object.
     */
    ...
    /**
     * Compares this with another <code>DistributionGivingOut</code> instance.  If
     * <code>obj</code> is an instance of <code>DistributionGivingOut</code>, delegates to
     * <code>equals(DistributionGivingOut)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|DistributionGivingOut The current object, for fluid interface
     */
     ...
     * @return $this|\API\Models\OIP\DistributionGivingOut The current object (for fluent API support)
     */
    public function setDistributionGivingOutid($v)
    {
        ...
        if ($this->distribution_giving_outid !== $v) {
            ...
            $this->modifiedColumns[DistributionGivingOutTableMap::COL_DISTRIBUTION_GIVING_OUTID] = true;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            if ($this->date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[DistributionGivingOutTableMap::COL_DATE] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : DistributionGivingOutTableMap::translateFieldName('DistributionGivingOutid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->distribution_giving_outid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : DistributionGivingOutTableMap::translateFieldName('Date', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = DistributionGivingOutTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\API\\Models\\OIP\\DistributionGivingOut'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildDistributionGivingOutQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see DistributionGivingOut::setDeleted()
     * @see DistributionGivingOut::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildDistributionGivingOutQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DistributionGivingOutTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->orderInProgressRecievedsScheduledForDeletion !== null) {
                if (!$this->orderInProgressRecievedsScheduledForDeletion->isEmpty()) {
                    \API\Models\OIP\OrderInProgressRecievedQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[DistributionGivingOutTableMap::COL_DISTRIBUTION_GIVING_OUTID] = true;
        if (null !== $this->distribution_giving_outid) {
        ...
        $this->setDistributionGivingOutid($pk);
    ...
    {
        $pos = DistributionGivingOutTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['DistributionGivingOut'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['DistributionGivingOut'][$this->hashCode()] = true;
        $keys = DistributionGivingOutTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getDistributionGivingOutid(),
            $keys[1] => $this->getDate(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\API\Models\OIP\DistributionGivingOut
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setDistributionGivingOutid($arr[$keys[0]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Models\OIP\DistributionGivingOut The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DistributionGivingOutTableMap::COL_DISTRIBUTION_GIVING_OUTID)) {
            $criteria->add(DistributionGivingOutTableMap::COL_DISTRIBUTION_GIVING_OUTID, $this->distribution_giving_outid);
        }
        if ($this->isColumnModified(DistributionGivingOutTableMap::COL_DATE)) {
            $criteria->add(DistributionGivingOutTableMap::COL_DATE, $this->date);
        }
    ...
    {
        $criteria = ChildDistributionGivingOutQuery::create();
        $criteria->add(DistributionGivingOutTableMap::COL_DISTRIBUTION_GIVING_OUTID, $this->distribution_giving_outid);
    ...
    {
        $validPk = null !== $this->getDistributionGivingOutid();
    ...
    /**
     * Generic method to set the primary key (distribution_giving_outid column).
     *
    ...
    {
        $this->setDistributionGivingOutid($key);
    }
    ...
    {
        return null === $this->getDistributionGivingOutid();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \API\Models\OIP\DistributionGivingOut (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setDistributionGivingOutid(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Models\OIP\DistributionGivingOut Clone of current object.
     * @throws PropelException
     */
    ...
    public function initOrderInProgressRecieveds($overrideExisting = true)
    {
        ...
        $this->collOrderInProgressRecieveds->setModel('\API\Models\OIP\OrderInProgressRecieved');
    }
     ...
     * If this ChildDistributionGivingOut is new, it will return
        ...
        if (null === $this->collOrderInProgressRecieveds || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collOrderInProgressRecieveds) {
                ...
                $collOrderInProgressRecieveds = ChildOrderInProgressRecievedQuery::create(null, $criteria)
                    ->filterByDistributionGivingOut($this)
                    ->find($con);
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildDistributionGivingOut The current object (for fluent API support)
     */
    public function setOrderInProgressRecieveds(Collection $orderInProgressRecieveds, ConnectionInterface $con = null)
    {
        ...
        foreach ($orderInProgressRecievedsToDelete as $orderInProgressRecievedRemoved) {
            $orderInProgressRecievedRemoved->setDistributionGivingOut(null);
        }
    ...
    protected function doAddOrderInProgressRecieved(ChildOrderInProgressRecieved $orderInProgressRecieved)
    {
        ...
        $orderInProgressRecieved->setDistributionGivingOut($this);
    }
    ...
    public function removeOrderInProgressRecieved(ChildOrderInProgressRecieved $orderInProgressRecieved)
    {
        if ($this->getOrderInProgressRecieveds()->contains($orderInProgressRecieved)) {
            ...
            $orderInProgressRecieved->setDistributionGivingOut(null);
        }
     ...
     * Otherwise if this DistributionGivingOut is new, it will return
     * an empty collection; or if this DistributionGivingOut has previously
     * been saved, it will retrieve related OrderInProgressRecieveds from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in DistributionGivingOut.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(DistributionGivingOutTableMap::DEFAULT_STRING_FORMAT);
    }
