 ...
 *
 * @method     \API\Models\Ordering\OrderDetailQuery|\API\Models\OIP\OrderInProgressQuery|\API\Models\OIP\DistributionGivingOutQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class OrderInProgressRecievedQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \API\Models\OIP\Base\OrderInProgressRecievedQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\API\\Models\\OIP\\OrderInProgressRecieved', $modelAlias = null)
    {
     ...
     *
     * @param \API\Models\OIP\OrderInProgress|ObjectCollection $orderInProgress The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    /**
     * Filter the query by a related \API\Models\OIP\DistributionGivingOut object
     *
     * @param \API\Models\OIP\DistributionGivingOut|ObjectCollection $distributionGivingOut The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($distributionGivingOut instanceof \API\Models\OIP\DistributionGivingOut) {
            return $this
            ...
            throw new PropelException('filterByDistributionGivingOut() only accepts arguments of type \API\Models\OIP\DistributionGivingOut or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \API\Models\OIP\DistributionGivingOutQuery A secondary query class using the current class as primary query
     */
    public function useDistributionGivingOutQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'DistributionGivingOut', '\API\Models\OIP\DistributionGivingOutQuery');
    }
