...
use API\Models\OIP\Map\DistributionsGivingOutsTableMap;
...
/**
 * Base class that represents a row from the 'distributions_giving_outs' table.
 *
 *
 *
 * @package    propel.generator.API.Models.OIP.Base
 */
abstract class DistributionsGivingOuts implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Models\\OIP\\Map\\DistributionsGivingOutsTableMap';
    ...
    /**
     * Initializes internal state of API\Models\OIP\Base\DistributionsGivingOuts object.
     */
    ...
    /**
     * Compares this with another <code>DistributionsGivingOuts</code> instance.  If
     * <code>obj</code> is an instance of <code>DistributionsGivingOuts</code>, delegates to
     * <code>equals(DistributionsGivingOuts)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|DistributionsGivingOuts The current object, for fluid interface
     */
     ...
     * @return $this|\API\Models\OIP\DistributionsGivingOuts The current object (for fluent API support)
     */
    public function setDistributionsGivingOutid($v)
    {
        ...
        if ($this->distributions_giving_outid !== $v) {
            ...
            $this->modifiedColumns[DistributionsGivingOutsTableMap::COL_DISTRIBUTIONS_GIVING_OUTID] = true;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            if ($this->date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[DistributionsGivingOutsTableMap::COL_DATE] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : DistributionsGivingOutsTableMap::translateFieldName('DistributionsGivingOutid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->distributions_giving_outid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : DistributionsGivingOutsTableMap::translateFieldName('Date', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = DistributionsGivingOutsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\API\\Models\\OIP\\DistributionsGivingOuts'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildDistributionsGivingOutsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see DistributionsGivingOuts::setDeleted()
     * @see DistributionsGivingOuts::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildDistributionsGivingOutsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DistributionsGivingOutsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[DistributionsGivingOutsTableMap::COL_DISTRIBUTIONS_GIVING_OUTID] = true;
        if (null !== $this->distributions_giving_outid) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . DistributionsGivingOutsTableMap::COL_DISTRIBUTIONS_GIVING_OUTID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(DistributionsGivingOutsTableMap::COL_DISTRIBUTIONS_GIVING_OUTID)) {
            $modifiedColumns[':p' . $index++]  = 'distributions_giving_outid';
        }
        if ($this->isColumnModified(DistributionsGivingOutsTableMap::COL_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'date';
        }

        $sql = sprintf(
            'INSERT INTO distributions_giving_outs (%s) VALUES (%s)',
        ...
        $this->setDistributionsGivingOutid($pk);
    ...
    {
        $pos = DistributionsGivingOutsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['DistributionsGivingOuts'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['DistributionsGivingOuts'][$this->hashCode()] = true;
        $keys = DistributionsGivingOutsTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getDistributionsGivingOutid(),
            $keys[1] => $this->getDate(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\API\Models\OIP\DistributionsGivingOuts
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setDistributionsGivingOutid($arr[$keys[0]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Models\OIP\DistributionsGivingOuts The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(DistributionsGivingOutsTableMap::DATABASE_NAME);

        if ($this->isColumnModified(DistributionsGivingOutsTableMap::COL_DISTRIBUTIONS_GIVING_OUTID)) {
            $criteria->add(DistributionsGivingOutsTableMap::COL_DISTRIBUTIONS_GIVING_OUTID, $this->distributions_giving_outid);
        }
        if ($this->isColumnModified(DistributionsGivingOutsTableMap::COL_DATE)) {
            $criteria->add(DistributionsGivingOutsTableMap::COL_DATE, $this->date);
        }
    ...
    {
        $criteria = ChildDistributionsGivingOutsQuery::create();
        $criteria->add(DistributionsGivingOutsTableMap::COL_DISTRIBUTIONS_GIVING_OUTID, $this->distributions_giving_outid);
    ...
    {
        $validPk = null !== $this->getDistributionsGivingOutid();
    ...
    /**
     * Generic method to set the primary key (distributions_giving_outid column).
     *
    ...
    {
        $this->setDistributionsGivingOutid($key);
    }
    ...
    {
        return null === $this->getDistributionsGivingOutid();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \API\Models\OIP\DistributionsGivingOuts (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setDistributionsGivingOutid(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Models\OIP\DistributionsGivingOuts Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildDistributionsGivingOuts is new, it will return
        ...
        if (null === $this->collOrdersInProgressRecieveds || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collOrdersInProgressRecieveds) {
                ...
                $collOrdersInProgressRecieveds = ChildOrdersInProgressRecievedQuery::create(null, $criteria)
                    ->filterByDistributionsGivingOuts($this)
                    ->find($con);
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildDistributionsGivingOuts The current object (for fluent API support)
     */
    public function setOrdersInProgressRecieveds(Collection $ordersInProgressRecieveds, ConnectionInterface $con = null)
    {
        ...
        foreach ($ordersInProgressRecievedsToDelete as $ordersInProgressRecievedRemoved) {
            $ordersInProgressRecievedRemoved->setDistributionsGivingOuts(null);
        }
    ...
    protected function doAddOrdersInProgressRecieved(ChildOrdersInProgressRecieved $ordersInProgressRecieved)
    {
        ...
        $ordersInProgressRecieved->setDistributionsGivingOuts($this);
    }
    ...
    public function removeOrdersInProgressRecieved(ChildOrdersInProgressRecieved $ordersInProgressRecieved)
    {
        if ($this->getOrdersInProgressRecieveds()->contains($ordersInProgressRecieved)) {
            ...
            $ordersInProgressRecieved->setDistributionsGivingOuts(null);
        }
     ...
     * Otherwise if this DistributionsGivingOuts is new, it will return
     * an empty collection; or if this DistributionsGivingOuts has previously
     * been saved, it will retrieve related OrdersInProgressRecieveds from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in DistributionsGivingOuts.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(DistributionsGivingOutsTableMap::DEFAULT_STRING_FORMAT);
    }
