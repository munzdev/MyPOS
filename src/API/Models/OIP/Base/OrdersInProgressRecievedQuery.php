 ...
 *
 * @method     \API\Models\Ordering\OrdersDetailsQuery|\API\Models\OIP\OrdersInProgressQuery|\API\Models\OIP\DistributionsGivingOutsQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class OrdersInProgressRecievedQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \API\Models\OIP\Base\OrdersInProgressRecievedQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\API\\Models\\OIP\\OrdersInProgressRecieved', $modelAlias = null)
    {
     ...
     *
     * @param \API\Models\OIP\OrdersInProgress|ObjectCollection $ordersInProgress The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    /**
     * Filter the query by a related \API\Models\OIP\DistributionsGivingOuts object
     *
     * @param \API\Models\OIP\DistributionsGivingOuts|ObjectCollection $distributionsGivingOuts The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($distributionsGivingOuts instanceof \API\Models\OIP\DistributionsGivingOuts) {
            return $this
            ...
            throw new PropelException('filterByDistributionsGivingOuts() only accepts arguments of type \API\Models\OIP\DistributionsGivingOuts or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \API\Models\OIP\DistributionsGivingOutsQuery A secondary query class using the current class as primary query
     */
    public function useDistributionsGivingOutsQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'DistributionsGivingOuts', '\API\Models\OIP\DistributionsGivingOutsQuery');
    }
