...
use API\Models\Menues\MenuGroupesQuery;
...
use API\Models\OIP\OrdersInProgressRecieved as ChildOrdersInProgressRecieved;
...
/**
 * Base class that represents a row from the 'orders_in_progress' table.
 *
 *
 *
 * @package    propel.generator.API.Models.OIP.Base
 */
abstract class OrdersInProgress implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Models\\OIP\\Map\\OrdersInProgressTableMap';
    ...
    /**
     * @var        ObjectCollection|ChildOrdersInProgressRecieved[] Collection to store aggregation of ChildOrdersInProgressRecieved objects.
     */
     ...
     * @var ObjectCollection|ChildOrdersInProgressRecieved[]
     */
    protected $ordersInProgressRecievedsScheduledForDeletion = null;

    /**
     * Initializes internal state of API\Models\OIP\Base\OrdersInProgress object.
     */
    ...
    /**
     * Compares this with another <code>OrdersInProgress</code> instance.  If
     * <code>obj</code> is an instance of <code>OrdersInProgress</code>, delegates to
     * <code>equals(OrdersInProgress)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|OrdersInProgress The current object, for fluid interface
     */
     ...
     * @return $this|\API\Models\OIP\OrdersInProgress The current object (for fluent API support)
     */
    public function setOrdersInProgressid($v)
    {
        ...
        if ($this->orders_in_progressid !== $v) {
            ...
            $this->modifiedColumns[OrdersInProgressTableMap::COL_ORDERS_IN_PROGRESSID] = true;
        }
    ...
    public function setOrderid($v)
    {
        ...
        if ($this->orderid !== $v) {
            $this->orderid = $v;
            $this->modifiedColumns[OrdersInProgressTableMap::COL_ORDERID] = true;
        }
    ...
    public function setUserid($v)
    {
        ...
        if ($this->userid !== $v) {
            $this->userid = $v;
            $this->modifiedColumns[OrdersInProgressTableMap::COL_USERID] = true;
        }
    ...
    public function setMenuGroupid($v)
    {
        ...
        if ($this->menu_groupid !== $v) {
            $this->menu_groupid = $v;
            $this->modifiedColumns[OrdersInProgressTableMap::COL_MENU_GROUPID] = true;
        }
    ...
    public function setBegin($v)
    {
        ...
        if ($this->begin !== null || $dt !== null) {
            if ($this->begin === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->begin->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[OrdersInProgressTableMap::COL_BEGIN] = true;
            }
    ...
    public function setDone($v)
    {
        ...
        if ($this->done !== null || $dt !== null) {
            if ($this->done === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->done->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[OrdersInProgressTableMap::COL_DONE] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : OrdersInProgressTableMap::translateFieldName('OrdersInProgressid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->orders_in_progressid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : OrdersInProgressTableMap::translateFieldName('Orderid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->orderid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : OrdersInProgressTableMap::translateFieldName('Userid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->userid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : OrdersInProgressTableMap::translateFieldName('MenuGroupid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->menu_groupid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : OrdersInProgressTableMap::translateFieldName('Begin', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->begin = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : OrdersInProgressTableMap::translateFieldName('Done', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 6; // 6 = OrdersInProgressTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\API\\Models\\OIP\\OrdersInProgress'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildOrdersInProgressQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see OrdersInProgress::setDeleted()
     * @see OrdersInProgress::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildOrdersInProgressQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OrdersInProgressTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->ordersInProgressRecievedsScheduledForDeletion !== null) {
                if (!$this->ordersInProgressRecievedsScheduledForDeletion->isEmpty()) {
                    \API\Models\OIP\OrdersInProgressRecievedQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[OrdersInProgressTableMap::COL_ORDERS_IN_PROGRESSID] = true;
        if (null !== $this->orders_in_progressid) {
        ...
        if ($this->isColumnModified(OrdersInProgressTableMap::COL_ORDERS_IN_PROGRESSID)) {
            $modifiedColumns[':p' . $index++]  = 'orders_in_progressid';
        }
        if ($this->isColumnModified(OrdersInProgressTableMap::COL_ORDERID)) {
            $modifiedColumns[':p' . $index++]  = 'orderid';
        }
        if ($this->isColumnModified(OrdersInProgressTableMap::COL_USERID)) {
            $modifiedColumns[':p' . $index++]  = 'userid';
        }
        if ($this->isColumnModified(OrdersInProgressTableMap::COL_MENU_GROUPID)) {
            $modifiedColumns[':p' . $index++]  = 'menu_groupid';
        }
        if ($this->isColumnModified(OrdersInProgressTableMap::COL_BEGIN)) {
            $modifiedColumns[':p' . $index++]  = 'begin';
        }
        if ($this->isColumnModified(OrdersInProgressTableMap::COL_DONE)) {
            $modifiedColumns[':p' . $index++]  = 'done';
        }

        $sql = sprintf(
            'INSERT INTO orders_in_progress (%s) VALUES (%s)',
    ...
    {
        $pos = OrdersInProgressTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['OrdersInProgress'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['OrdersInProgress'][$this->hashCode()] = true;
        $keys = OrdersInProgressTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getOrdersInProgressid(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\API\Models\OIP\OrdersInProgress
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setOrdersInProgressid($arr[$keys[0]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Models\OIP\OrdersInProgress The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OrdersInProgressTableMap::COL_ORDERS_IN_PROGRESSID)) {
            $criteria->add(OrdersInProgressTableMap::COL_ORDERS_IN_PROGRESSID, $this->orders_in_progressid);
        }
        if ($this->isColumnModified(OrdersInProgressTableMap::COL_ORDERID)) {
            $criteria->add(OrdersInProgressTableMap::COL_ORDERID, $this->orderid);
        }
        if ($this->isColumnModified(OrdersInProgressTableMap::COL_USERID)) {
            $criteria->add(OrdersInProgressTableMap::COL_USERID, $this->userid);
        }
        if ($this->isColumnModified(OrdersInProgressTableMap::COL_MENU_GROUPID)) {
            $criteria->add(OrdersInProgressTableMap::COL_MENU_GROUPID, $this->menu_groupid);
        }
        if ($this->isColumnModified(OrdersInProgressTableMap::COL_BEGIN)) {
            $criteria->add(OrdersInProgressTableMap::COL_BEGIN, $this->begin);
        }
        if ($this->isColumnModified(OrdersInProgressTableMap::COL_DONE)) {
            $criteria->add(OrdersInProgressTableMap::COL_DONE, $this->done);
        }
    ...
    {
        $criteria = ChildOrdersInProgressQuery::create();
        $criteria->add(OrdersInProgressTableMap::COL_ORDERS_IN_PROGRESSID, $this->orders_in_progressid);
        $criteria->add(OrdersInProgressTableMap::COL_ORDERID, $this->orderid);
        $criteria->add(OrdersInProgressTableMap::COL_USERID, $this->userid);
        $criteria->add(OrdersInProgressTableMap::COL_MENU_GROUPID, $this->menu_groupid);
    ...
    {
        $validPk = null !== $this->getOrdersInProgressid() &&
        ...
        //relation fk_orders_in_progress_menu_groupes1 to table menu_groupes
        ...
        //relation fk_orders_in_progress_orders1 to table orders
        ...
        //relation fk_orders_in_progress_users1 to table users
    ...
    {
        $pks = array();
        $pks[0] = $this->getOrdersInProgressid();
    ...
    {
        $this->setOrdersInProgressid($keys[0]);
    ...
    {
        return (null === $this->getOrdersInProgressid()) && (null === $this->getOrderid()) && (null === $this->getUserid()) && (null === $this->getMenuGroupid());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \API\Models\OIP\OrdersInProgress (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setOrdersInProgressid(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Models\OIP\OrdersInProgress Clone of current object.
     * @throws PropelException
     */
    ...
    public function getMenuGroupes(ConnectionInterface $con = null)
    {
        if ($this->aMenuGroupes === null && ($this->menu_groupid !== null)) {
            $this->aMenuGroupes = MenuGroupesQuery::create()
                ->filterByOrdersInProgress($this) // here
                ->findOne($con);
            /* The following can be used additionally to
                ...
                $this->aMenuGroupes->addOrdersInProgresses($this);
             */
        }
    ...
    public function getOrders(ConnectionInterface $con = null)
    {
        if ($this->aOrders === null && ($this->orderid !== null)) {
            $this->aOrders = OrdersQuery::create()
                ->filterByOrdersInProgress($this) // here
                ->findOne($con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aOrders->addOrdersInProgresses($this);
             */
        }
    ...
    public function getUsers(ConnectionInterface $con = null)
    {
        if ($this->aUsers === null && ($this->userid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUsers->addOrdersInProgresses($this);
             */
        }
    ...
    public function initOrdersInProgressRecieveds($overrideExisting = true)
    {
        ...
        $this->collOrdersInProgressRecieveds->setModel('\API\Models\OIP\OrdersInProgressRecieved');
    }

    /**
     * Gets an array of ChildOrdersInProgressRecieved objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     * If this ChildOrdersInProgress is new, it will return
     * an empty collection or the current collection; the criteria is ignored on a new object.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     * @return ObjectCollection|ChildOrdersInProgressRecieved[] List of ChildOrdersInProgressRecieved objects
     * @throws PropelException
     */
    public function getOrdersInProgressRecieveds(Criteria $criteria = null, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collOrdersInProgressRecieveds || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collOrdersInProgressRecieveds) {
                ...
                $collOrdersInProgressRecieveds = ChildOrdersInProgressRecievedQuery::create(null, $criteria)
                    ->filterByOrdersInProgress($this)
                    ->find($con);
    ...
    /**
     * Sets a collection of ChildOrdersInProgressRecieved objects related by a one-to-many relationship
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildOrdersInProgress The current object (for fluent API support)
     */
    public function setOrdersInProgressRecieveds(Collection $ordersInProgressRecieveds, ConnectionInterface $con = null)
    {
        /** @var ChildOrdersInProgressRecieved[] $ordersInProgressRecievedsToDelete */
        ...
        foreach ($ordersInProgressRecievedsToDelete as $ordersInProgressRecievedRemoved) {
            $ordersInProgressRecievedRemoved->setOrdersInProgress(null);
        }
    ...
    /**
     * Returns the number of related OrdersInProgressRecieved objects.
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct
     * @param      ConnectionInterface $con
     * @return int             Count of related OrdersInProgressRecieved objects.
     * @throws PropelException
     */
    public function countOrdersInProgressRecieveds(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collOrdersInProgressRecieveds || null !== $criteria || $partial) {
            ...
            $query = ChildOrdersInProgressRecievedQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * Method called to associate a ChildOrdersInProgressRecieved object to this object
     * through the ChildOrdersInProgressRecieved foreign key attribute.
     *
     * @param  ChildOrdersInProgressRecieved $l ChildOrdersInProgressRecieved
     * @return $this|\API\Models\OIP\OrdersInProgress The current object (for fluent API support)
     */
    public function addOrdersInProgressRecieved(ChildOrdersInProgressRecieved $l)
    {
        if ($this->collOrdersInProgressRecieveds === null) {
            $this->initOrdersInProgressRecieveds();
            $this->collOrdersInProgressRecievedsPartial = true;
    ...
    /**
     * @param ChildOrdersInProgressRecieved $ordersInProgressRecieved The ChildOrdersInProgressRecieved object to add.
     */
    protected function doAddOrdersInProgressRecieved(ChildOrdersInProgressRecieved $ordersInProgressRecieved)
    {
        $this->collOrdersInProgressRecieveds[]= $ordersInProgressRecieved;
        $ordersInProgressRecieved->setOrdersInProgress($this);
    }

    /**
     * @param  ChildOrdersInProgressRecieved $ordersInProgressRecieved The ChildOrdersInProgressRecieved object to remove.
     * @return $this|ChildOrdersInProgress The current object (for fluent API support)
     */
    public function removeOrdersInProgressRecieved(ChildOrdersInProgressRecieved $ordersInProgressRecieved)
    {
        if ($this->getOrdersInProgressRecieveds()->contains($ordersInProgressRecieved)) {
            ...
            $ordersInProgressRecieved->setOrdersInProgress(null);
        }
     ...
     * Otherwise if this OrdersInProgress is new, it will return
     * an empty collection; or if this OrdersInProgress has previously
     * been saved, it will retrieve related OrdersInProgressRecieveds from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in OrdersInProgress.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildOrdersInProgressRecieved[] List of ChildOrdersInProgressRecieved objects
     */
    public function getOrdersInProgressRecievedsJoinOrdersDetails(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildOrdersInProgressRecievedQuery::create(null, $criteria);
    ...
    {
        if (null !== $this->aMenuGroupes) {
            $this->aMenuGroupes->removeOrdersInProgress($this);
        }
        if (null !== $this->aOrders) {
            $this->aOrders->removeOrdersInProgress($this);
        }
        if (null !== $this->aUsers) {
            $this->aUsers->removeOrdersInProgress($this);
        }
    ...
    {
        return (string) $this->exportTo(OrdersInProgressTableMap::DEFAULT_STRING_FORMAT);
    }
