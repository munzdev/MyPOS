...
class OrderInProgressRecievedTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.OIP.Map.OrderInProgressRecievedTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\OIP\\OrderInProgressRecieved';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.OIP.OrderInProgressRecieved';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\API\\Models\\OIP\\OrderInProgressRecieved');
...
*/
    ...
    public static function doDelete($values, ConnectionInterface $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\OIP\OrderInProgressRecieved) { // it's a model object
