...
use API\Models\Invoice\Base\InvoicesItems as BaseInvoicesItems;
...
use API\Models\OIP\Base\OrdersInProgressRecieved as BaseOrdersInProgressRecieved;
...
abstract class OrdersDetails implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Models\\Ordering\\Map\\OrdersDetailsTableMap';
    ...
    /**
     * Initializes internal state of API\Models\Ordering\Base\OrdersDetails object.
     */
     ...
     * @return $this|\API\Models\Ordering\OrdersDetails The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\API\\Models\\Ordering\\OrdersDetails'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\API\Models\Ordering\OrdersDetails
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Models\Ordering\OrdersDetails The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \API\Models\Ordering\OrdersDetails (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Models\Ordering\OrdersDetails Clone of current object.
     * @throws PropelException
     */
