 ...
 *
 * @method     \API\Models\Menues\AvailabilitysQuery|\API\Models\Menues\MenuGroupesQuery|\API\Models\Menues\MenuSizesQuery|\API\Models\Menues\MenuesQuery|\API\Models\Ordering\OrdersQuery|\API\Models\User\UsersQuery|\API\Models\Invoice\InvoicesItemsQuery|\API\Models\Ordering\OrdersDetailExtrasQuery|\API\Models\Ordering\OrdersDetailsMixedWithQuery|\API\Models\OIP\OrdersInProgressRecievedQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class OrdersDetailsQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \API\Models\Ordering\Base\OrdersDetailsQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\API\\Models\\Ordering\\OrdersDetails', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \API\Models\Ordering\OrdersDetailExtras object
     *
     * @param \API\Models\Ordering\OrdersDetailExtras|ObjectCollection $ordersDetailExtras the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildOrdersDetailsQuery The current query, for fluid interface
     */
    ...
    {
        if ($ordersDetailExtras instanceof \API\Models\Ordering\OrdersDetailExtras) {
            return $this
            ...
            throw new PropelException('filterByOrdersDetailExtras() only accepts arguments of type \API\Models\Ordering\OrdersDetailExtras or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \API\Models\Ordering\OrdersDetailExtrasQuery A secondary query class using the current class as primary query
     */
    public function useOrdersDetailExtrasQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'OrdersDetailExtras', '\API\Models\Ordering\OrdersDetailExtrasQuery');
    }

    /**
     * Filter the query by a related \API\Models\Ordering\OrdersDetailsMixedWith object
     *
     * @param \API\Models\Ordering\OrdersDetailsMixedWith|ObjectCollection $ordersDetailsMixedWith the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildOrdersDetailsQuery The current query, for fluid interface
     */
    ...
    {
        if ($ordersDetailsMixedWith instanceof \API\Models\Ordering\OrdersDetailsMixedWith) {
            return $this
            ...
            throw new PropelException('filterByOrdersDetailsMixedWith() only accepts arguments of type \API\Models\Ordering\OrdersDetailsMixedWith or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \API\Models\Ordering\OrdersDetailsMixedWithQuery A secondary query class using the current class as primary query
     */
    public function useOrdersDetailsMixedWithQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'OrdersDetailsMixedWith', '\API\Models\Ordering\OrdersDetailsMixedWithQuery');
    }
