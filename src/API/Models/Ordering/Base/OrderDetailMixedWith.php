...
abstract class OrderDetailMixedWith implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Models\\Ordering\\Map\\OrderDetailMixedWithTableMap';
    ...
    /**
     * Initializes internal state of API\Models\Ordering\Base\OrderDetailMixedWith object.
     */
    ...
    /**
     * Compares this with another <code>OrderDetailMixedWith</code> instance.  If
     * <code>obj</code> is an instance of <code>OrderDetailMixedWith</code>, delegates to
     * <code>equals(OrderDetailMixedWith)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|OrderDetailMixedWith The current object, for fluid interface
     */
     ...
     * @return $this|\API\Models\Ordering\OrderDetailMixedWith The current object (for fluent API support)
     */
    public function setOrderDetailid($v)
    {
        ...
        if ($this->order_detailid !== $v) {
            ...
            $this->modifiedColumns[OrderDetailMixedWithTableMap::COL_ORDER_DETAILID] = true;
        }
    ...
    public function setMenuid($v)
    {
        ...
        if ($this->menuid !== $v) {
            $this->menuid = $v;
            $this->modifiedColumns[OrderDetailMixedWithTableMap::COL_MENUID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : OrderDetailMixedWithTableMap::translateFieldName('OrderDetailid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->order_detailid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : OrderDetailMixedWithTableMap::translateFieldName('Menuid', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = OrderDetailMixedWithTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\API\\Models\\Ordering\\OrderDetailMixedWith'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildOrderDetailMixedWithQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see OrderDetailMixedWith::setDeleted()
     * @see OrderDetailMixedWith::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildOrderDetailMixedWithQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OrderDetailMixedWithTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(OrderDetailMixedWithTableMap::COL_ORDER_DETAILID)) {
            $modifiedColumns[':p' . $index++]  = 'order_detailid';
        }
        if ($this->isColumnModified(OrderDetailMixedWithTableMap::COL_MENUID)) {
            $modifiedColumns[':p' . $index++]  = 'menuid';
        }

        $sql = sprintf(
            'INSERT INTO order_detail_mixed_with (%s) VALUES (%s)',
    ...
    {
        $pos = OrderDetailMixedWithTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['OrderDetailMixedWith'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['OrderDetailMixedWith'][$this->hashCode()] = true;
        $keys = OrderDetailMixedWithTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\API\Models\Ordering\OrderDetailMixedWith
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Models\Ordering\OrderDetailMixedWith The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OrderDetailMixedWithTableMap::COL_ORDER_DETAILID)) {
            $criteria->add(OrderDetailMixedWithTableMap::COL_ORDER_DETAILID, $this->order_detailid);
        }
        if ($this->isColumnModified(OrderDetailMixedWithTableMap::COL_MENUID)) {
            $criteria->add(OrderDetailMixedWithTableMap::COL_MENUID, $this->menuid);
        }
    ...
    {
        $criteria = ChildOrderDetailMixedWithQuery::create();
        $criteria->add(OrderDetailMixedWithTableMap::COL_ORDER_DETAILID, $this->order_detailid);
        $criteria->add(OrderDetailMixedWithTableMap::COL_MENUID, $this->menuid);
    ...
    public function hashCode()
    {
        ...
        //relation fk_orders_details_mixed_with_menues1 to table menu
        ...
        //relation fk_orders_details_mixed_with_orders_details1 to table order_detail
    ...
    {
        return (null === $this->getOrderDetailid()) && (null === $this->getMenuid());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \API\Models\Ordering\OrderDetailMixedWith (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Models\Ordering\OrderDetailMixedWith Clone of current object.
     * @throws PropelException
     */
    ...
    public function setMenu(Menu $v = null)
    {
        ...
        if ($v !== null) {
            $v->addOrderDetailMixedWith($this);
        }
    ...
    public function getMenu(ConnectionInterface $con = null)
    {
        if ($this->aMenu === null && ($this->menuid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aMenu->addOrderDetailMixedWiths($this);
             */
        }
    ...
    public function getOrderDetail(ConnectionInterface $con = null)
    {
        if ($this->aOrderDetail === null && ($this->order_detailid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aOrderDetail->addOrderDetailMixedWiths($this);
             */
        }
    ...
    {
        if (null !== $this->aMenu) {
            $this->aMenu->removeOrderDetailMixedWith($this);
        }
        if (null !== $this->aOrderDetail) {
            $this->aOrderDetail->removeOrderDetailMixedWith($this);
        }
    ...
    {
        return (string) $this->exportTo(OrderDetailMixedWithTableMap::DEFAULT_STRING_FORMAT);
    }
