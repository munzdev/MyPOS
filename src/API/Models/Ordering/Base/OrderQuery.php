...
*/
    ...
    public function filterByUserRelatedByCancellationCreatedByUserid($user, $comparison = null)
    {
        if ($user instanceof \API\Models\User\User) {
            ...
            throw new PropelException('filterByUserRelatedByCancellationCreatedByUserid() only accepts arguments of type \API\Models\User\User or Collection');
        }
    }
    ...
    public function useUserRelatedByCancellationCreatedByUseridQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'UserRelatedByCancellationCreatedByUserid', '\API\Models\User\UserQuery');
    }
    ...
    public function filterByUserRelatedByUserid($user, $comparison = null)
    {
        if ($user instanceof \API\Models\User\User) {
            ...
            throw new PropelException('filterByUserRelatedByUserid() only accepts arguments of type \API\Models\User\User or Collection');
        }
    }
    ...
    public function useUserRelatedByUseridQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'UserRelatedByUserid', '\API\Models\User\UserQuery');
    }
