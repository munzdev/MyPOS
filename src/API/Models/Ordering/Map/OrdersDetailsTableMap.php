...
class OrdersDetailsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.Ordering.Map.OrdersDetailsTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\Ordering\\OrdersDetails';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.Ordering.OrdersDetails';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\API\\Models\\Ordering\\OrdersDetails');
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \API\Models\Ordering\OrdersDetails $obj A \API\Models\Ordering\OrdersDetails object.
     ...
     *
     * @param mixed $value A \API\Models\Ordering\OrdersDetails object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \API\Models\Ordering\OrdersDetails) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \API\Models\Ordering\OrdersDetails object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\Ordering\OrdersDetails) { // it's a model object
