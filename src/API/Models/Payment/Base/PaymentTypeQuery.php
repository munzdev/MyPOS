 ...
 *
 * @method     ChildPaymentTypeQuery leftJoinPayment($relationAlias = null) Adds a LEFT JOIN clause to the query using the Payment relation
 * @method     ChildPaymentTypeQuery rightJoinPayment($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Payment relation
 * @method     ChildPaymentTypeQuery innerJoinPayment($relationAlias = null) Adds a INNER JOIN clause to the query using the Payment relation
 *
 * @method     ChildPaymentTypeQuery joinWithPayment($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Payment relation
 *
 * @method     ChildPaymentTypeQuery leftJoinWithPayment() Adds a LEFT JOIN clause and with to the query using the Payment relation
 * @method     ChildPaymentTypeQuery rightJoinWithPayment() Adds a RIGHT JOIN clause and with to the query using the Payment relation
 * @method     ChildPaymentTypeQuery innerJoinWithPayment() Adds a INNER JOIN clause and with to the query using the Payment relation
 *
 * @method     \API\Models\Payment\PaymentQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class PaymentTypeQuery extends ModelCriteria
{
    ...
    public function filterByPayment($payment, $comparison = null)
    {
        if ($payment instanceof \API\Models\Payment\Payment) {
            return $this
                ->addUsingAlias(PaymentTypeTableMap::COL_PAYMENT_TYPEID, $payment->getPaymentTypeid(), $comparison);
