 ...
 *
 * @method     \API\Models\Payment\CouponsQuery|\API\Models\Payment\PaymentsQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class PaymentsCouponsQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \API\Models\Payment\Base\PaymentsCouponsQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\API\\Models\\Payment\\PaymentsCoupons', $modelAlias = null)
    {
     ...
     *
     * @param \API\Models\Payment\Coupons|ObjectCollection $coupons The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
     ...
     *
     * @param \API\Models\Payment\Payments|ObjectCollection $payments The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
