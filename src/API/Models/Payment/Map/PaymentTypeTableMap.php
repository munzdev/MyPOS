...
class PaymentTypeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.Payment.Map.PaymentTypeTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\Payment\\PaymentType';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.Payment.PaymentType';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\API\\Models\\Payment\\PaymentType');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\Payment\PaymentType) { // it's a model object
