...
class CouponsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.Payment.Map.CouponsTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\Payment\\Coupons';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.Payment.Coupons';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\API\\Models\\Payment\\Coupons');
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \API\Models\Payment\Coupons $obj A \API\Models\Payment\Coupons object.
     ...
     *
     * @param mixed $value A \API\Models\Payment\Coupons object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \API\Models\Payment\Coupons) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \API\Models\Payment\Coupons object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\Payment\Coupons) { // it's a model object
