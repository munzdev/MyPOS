...
class PaymentsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.Payment.Map.PaymentsTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\Payment\\Payments';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.Payment.Payments';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\API\\Models\\Payment\\Payments');
  ...
  array (
    ...
    1 => ':invoiceid',
        ...
        $this->addRelation('PaymentTypes', '\\API\\Models\\Payment\\PaymentTypes', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':payment_typeid',
    1 => ':idpayment_typeid',
        ...
        $this->addRelation('PaymentsCoupons', '\\API\\Models\\Payment\\PaymentsCoupons', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':paymentid',
    1 => ':paymentid',
     ...
     * and findPk*() calls.
     *
     * @param \API\Models\Payment\Payments $obj A \API\Models\Payment\Payments object.
     ...
     *
     * @param mixed $value A \API\Models\Payment\Payments object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \API\Models\Payment\Payments) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \API\Models\Payment\Payments object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\Payment\Payments) { // it's a model object
