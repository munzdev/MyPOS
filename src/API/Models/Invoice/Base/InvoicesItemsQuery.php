 ...
 *
 * @method     \API\Models\Invoice\InvoicesQuery|\API\Models\Ordering\OrdersDetailsQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class InvoicesItemsQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \API\Models\Invoice\Base\InvoicesItemsQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\API\\Models\\Invoice\\InvoicesItems', $modelAlias = null)
    {
