...
class MenuExtraTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.Menu.Map.MenuExtraTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\Menu\\MenuExtra';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.Menu.MenuExtra';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\API\\Models\\Menu\\MenuExtra');
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \API\Models\Menu\MenuExtra $obj A \API\Models\Menu\MenuExtra object.
     ...
     *
     * @param mixed $value A \API\Models\Menu\MenuExtra object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \API\Models\Menu\MenuExtra) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \API\Models\Menu\MenuExtra object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    /**
     * Method to invalidate the instance pool of all tables related to menu_extra     * by a foreign key with ON DELETE CASCADE
     */
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\Menu\MenuExtra) { // it's a model object
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(MenuExtraTableMap::COL_MENU_EXTRAID, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(MenuExtraTableMap::COL_EVENTID, $value[1]));
