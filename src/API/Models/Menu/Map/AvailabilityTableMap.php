...
class AvailabilityTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Models.Menu.Map.AvailabilityTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Models\\Menu\\Availability';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Models.Menu.Availability';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\API\\Models\\Menu\\Availability');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Models\Menu\Availability) { // it's a model object
