...
class MenuGroupTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addForeignPrimaryKey('menu_typeid', 'MenuTypeid', 'INTEGER' , 'menu_type', 'menu_typeid', true, null, null);
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \API\Models\Menu\MenuGroup $obj A \API\Models\Menu\MenuGroup object.
     ...
     *
     * @param mixed $value A \API\Models\Menu\MenuGroup object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \API\Models\Menu\MenuGroup) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \API\Models\Menu\MenuGroup object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    /**
     * Method to invalidate the instance pool of all tables related to menu_group     * by a foreign key with ON DELETE CASCADE
     */
     ...
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(MenuGroupTableMap::COL_MENU_GROUPID, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(MenuGroupTableMap::COL_MENU_TYPEID, $value[1]));
