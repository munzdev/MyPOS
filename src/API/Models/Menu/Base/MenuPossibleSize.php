...
abstract class MenuPossibleSize implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Models\\Menu\\Map\\MenuPossibleSizeTableMap';
    ...
    /**
     * Initializes internal state of API\Models\Menu\Base\MenuPossibleSize object.
     */
     ...
     * @return $this|\API\Models\Menu\MenuPossibleSize The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\API\\Models\\Menu\\MenuPossibleSize'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\API\Models\Menu\MenuPossibleSize
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Models\Menu\MenuPossibleSize The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \API\Models\Menu\MenuPossibleSize (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Models\Menu\MenuPossibleSize Clone of current object.
     * @throws PropelException
     */
