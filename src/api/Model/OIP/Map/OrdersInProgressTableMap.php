...
class OrdersInProgressTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.OIP.Map.OrdersInProgressTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\OIP\\OrdersInProgress';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.OIP.OrdersInProgress';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Model\\OIP\\OrdersInProgress');
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \Model\OIP\OrdersInProgress $obj A \Model\OIP\OrdersInProgress object.
     ...
     *
     * @param mixed $value A \Model\OIP\OrdersInProgress object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Model\OIP\OrdersInProgress) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \Model\OIP\OrdersInProgress object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Model\OIP\OrdersInProgress) { // it's a model object
