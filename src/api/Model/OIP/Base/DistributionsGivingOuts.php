...
abstract class DistributionsGivingOuts implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\OIP\\Map\\DistributionsGivingOutsTableMap';
    ...
    /**
     * Initializes internal state of Model\OIP\Base\DistributionsGivingOuts object.
     */
     ...
     * @return $this|\Model\OIP\DistributionsGivingOuts The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\OIP\\DistributionsGivingOuts'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Model\OIP\DistributionsGivingOuts
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\OIP\DistributionsGivingOuts The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\OIP\DistributionsGivingOuts (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\OIP\DistributionsGivingOuts Clone of current object.
     * @throws PropelException
     */
