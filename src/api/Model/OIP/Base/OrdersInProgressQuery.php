 ...
 *
 * @method     \Model\Menues\MenuGroupesQuery|\Model\Ordering\OrdersQuery|\Model\User\UsersQuery|\Model\OIP\OrdersInProgressRecievedQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class OrdersInProgressQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Model\OIP\Base\OrdersInProgressQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Model\\OIP\\OrdersInProgress', $modelAlias = null)
    {
