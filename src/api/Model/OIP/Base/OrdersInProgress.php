...
use Model\OIP\OrdersInProgress as ChildOrdersInProgress;
use Model\OIP\OrdersInProgressQuery as ChildOrdersInProgressQuery;
...
use Model\Ordering\OrdersQuery;
 ...
 *
 *
 * @package    propel.generator.Model.OIP.Base
 */
abstract class OrdersInProgress implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\OIP\\Map\\OrdersInProgressTableMap';
    ...
    /**
     * Initializes internal state of Model\OIP\Base\OrdersInProgress object.
     */
     ...
     * @return $this|\Model\OIP\OrdersInProgress The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\OIP\\OrdersInProgress'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Model\OIP\OrdersInProgress
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\OIP\OrdersInProgress The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\OIP\OrdersInProgress (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\OIP\OrdersInProgress Clone of current object.
     * @throws PropelException
     */
