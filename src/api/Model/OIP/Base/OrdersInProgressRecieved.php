...
abstract class OrdersInProgressRecieved implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\OIP\\Map\\OrdersInProgressRecievedTableMap';
    ...
    /**
     * Initializes internal state of Model\OIP\Base\OrdersInProgressRecieved object.
     */
     ...
     * @return $this|\Model\OIP\OrdersInProgressRecieved The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\OIP\\OrdersInProgressRecieved'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Model\OIP\OrdersInProgressRecieved
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\OIP\OrdersInProgressRecieved The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\OIP\OrdersInProgressRecieved (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\OIP\OrdersInProgressRecieved Clone of current object.
     * @throws PropelException
     */
