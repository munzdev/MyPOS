...
use Model\DistributionPlace\Base\DistributionsPlaces as BaseDistributionsPlaces;
use Model\DistributionPlace\Map\DistributionsPlacesTableMap;
...
use Model\Event\EventsUser as ChildEventsUser;
use Model\Event\EventsUserQuery as ChildEventsUserQuery;
...
use Model\Menues\MenuExtrasQuery;
use Model\Menues\MenuSizes;
use Model\Menues\MenuSizesQuery;
use Model\Menues\MenuTypes;
use Model\Menues\MenuTypesQuery;
use Model\Menues\Base\MenuExtras as BaseMenuExtras;
use Model\Menues\Base\MenuSizes as BaseMenuSizes;
use Model\Menues\Base\MenuTypes as BaseMenuTypes;
...
use Model\Ordering\Base\Orders as BaseOrders;
use Model\Ordering\Map\OrdersTableMap;
use Model\Payment\Coupons;
use Model\Payment\CouponsQuery;
use Model\Payment\Base\Coupons as BaseCoupons;
use Model\Payment\Map\CouponsTableMap;
 ...
 *
 *
 * @package    propel.generator.Model.Event.Base
 */
abstract class Events implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Event\\Map\\EventsTableMap';
    ...
    /**
     * Initializes internal state of Model\Event\Base\Events object.
     */
     ...
     * @return $this|\Model\Event\Events The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\Event\\Events'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->couponssScheduledForDeletion !== null) {
                if (!$this->couponssScheduledForDeletion->isEmpty()) {
                    \Model\Payment\CouponsQuery::create()
            ...
            if ($this->distributionsPlacessScheduledForDeletion !== null) {
                if (!$this->distributionsPlacessScheduledForDeletion->isEmpty()) {
                    \Model\DistributionPlace\DistributionsPlacesQuery::create()
            ...
            if ($this->eventsPrinterssScheduledForDeletion !== null) {
                if (!$this->eventsPrinterssScheduledForDeletion->isEmpty()) {
                    \Model\Event\EventsPrintersQuery::create()
            ...
            if ($this->eventsTablessScheduledForDeletion !== null) {
                if (!$this->eventsTablessScheduledForDeletion->isEmpty()) {
                    \Model\Event\EventsTablesQuery::create()
            ...
            if ($this->eventsUsersScheduledForDeletion !== null) {
                if (!$this->eventsUsersScheduledForDeletion->isEmpty()) {
                    \Model\Event\EventsUserQuery::create()
            ...
            if ($this->menuSizessScheduledForDeletion !== null) {
                if (!$this->menuSizessScheduledForDeletion->isEmpty()) {
                    \Model\Menues\MenuSizesQuery::create()
            ...
            if ($this->menuTypessScheduledForDeletion !== null) {
                if (!$this->menuTypessScheduledForDeletion->isEmpty()) {
                    \Model\Menues\MenuTypesQuery::create()
            ...
            if ($this->orderssScheduledForDeletion !== null) {
                if (!$this->orderssScheduledForDeletion->isEmpty()) {
                    \Model\Ordering\OrdersQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Model\Event\Events
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\Event\Events The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\Event\Events (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Event\Events Clone of current object.
     * @throws PropelException
     */
    ...
    public function initCouponss($overrideExisting = true)
    {
        ...
        $this->collCouponss->setModel('\Model\Payment\Coupons');
    }
    ...
    public function initDistributionsPlacess($overrideExisting = true)
    {
        ...
        $this->collDistributionsPlacess->setModel('\Model\DistributionPlace\DistributionsPlaces');
    }
    ...
    public function initEventsPrinterss($overrideExisting = true)
    {
        ...
        $this->collEventsPrinterss->setModel('\Model\Event\EventsPrinters');
    }
    ...
    public function initEventsTabless($overrideExisting = true)
    {
        ...
        $this->collEventsTabless->setModel('\Model\Event\EventsTables');
    }
    ...
    public function initEventsUsers($overrideExisting = true)
    {
        ...
        $this->collEventsUsers->setModel('\Model\Event\EventsUser');
    }
    ...
    public function initMenuSizess($overrideExisting = true)
    {
        ...
        $this->collMenuSizess->setModel('\Model\Menues\MenuSizes');
    }
    ...
    public function initMenuTypess($overrideExisting = true)
    {
        ...
        $this->collMenuTypess->setModel('\Model\Menues\MenuTypes');
    }
    ...
    public function initOrderss($overrideExisting = true)
    {
        ...
        $this->collOrderss->setModel('\Model\Ordering\Orders');
    }
