...
abstract class EventsTables implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Event\\Map\\EventsTablesTableMap';
    ...
    /**
     * Initializes internal state of Model\Event\Base\EventsTables object.
     */
     ...
     * @return $this|\Model\Event\EventsTables The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\Event\\EventsTables'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Model\Event\EventsTables
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\Event\EventsTables The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\Event\EventsTables (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Event\EventsTables Clone of current object.
     * @throws PropelException
     */
