...
use Model\User\Messages\UsersMessages;
 ...
 *
 * @method     \Model\Event\EventsQuery|\Model\User\UsersQuery|\Model\User\Messages\UsersMessagesQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class EventsUserQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Model\Event\Base\EventsUserQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Model\\Event\\EventsUser', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \Model\User\Messages\UsersMessages object
     *
     * @param \Model\User\Messages\UsersMessages|ObjectCollection $usersMessages the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildEventsUserQuery The current query, for fluid interface
     */
    ...
    {
        if ($usersMessages instanceof \Model\User\Messages\UsersMessages) {
            return $this
            ...
            throw new PropelException('filterByUsersMessagesRelatedByFromEventsUserid() only accepts arguments of type \Model\User\Messages\UsersMessages or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Model\User\Messages\UsersMessagesQuery A secondary query class using the current class as primary query
     */
    public function useUsersMessagesRelatedByFromEventsUseridQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'UsersMessagesRelatedByFromEventsUserid', '\Model\User\Messages\UsersMessagesQuery');
    }
    ...
    public function filterByUsersMessagesRelatedByToEventsUserid($usersMessages, $comparison = null)
    {
        if ($usersMessages instanceof \Model\User\Messages\UsersMessages) {
            ...
            throw new PropelException('filterByUsersMessagesRelatedByToEventsUserid() only accepts arguments of type \Model\User\Messages\UsersMessages or Collection');
        }
    }
    ...
    public function useUsersMessagesRelatedByToEventsUseridQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'UsersMessagesRelatedByToEventsUserid', '\Model\User\Messages\UsersMessagesQuery');
    }
