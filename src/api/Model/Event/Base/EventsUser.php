...
use Model\User\Messages\Base\UsersMessages as BaseUsersMessages;
...
abstract class EventsUser implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Event\\Map\\EventsUserTableMap';
    ...
    /**
     * Initializes internal state of Model\Event\Base\EventsUser object.
     */
     ...
     * @return $this|\Model\Event\EventsUser The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\Event\\EventsUser'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->usersMessagessRelatedByFromEventsUseridScheduledForDeletion !== null) {
                if (!$this->usersMessagessRelatedByFromEventsUseridScheduledForDeletion->isEmpty()) {
                    \Model\User\Messages\UsersMessagesQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Model\Event\EventsUser
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\Event\EventsUser The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\Event\EventsUser (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Event\EventsUser Clone of current object.
     * @throws PropelException
     */
    ...
    public function initUsersMessagessRelatedByFromEventsUserid($overrideExisting = true)
    {
        ...
        $this->collUsersMessagessRelatedByFromEventsUserid->setModel('\Model\User\Messages\UsersMessages');
    }
    ...
    public function initUsersMessagessRelatedByToEventsUserid($overrideExisting = true)
    {
        ...
        $this->collUsersMessagessRelatedByToEventsUserid->setModel('\Model\User\Messages\UsersMessages');
    }
