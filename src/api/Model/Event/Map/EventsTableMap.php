...
class EventsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.Event.Map.EventsTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\Event\\Events';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.Event.Events';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Model\\Event\\Events');
  ...
  array (
    ...
    1 => ':eventid',
        ...
        $this->addRelation('DistributionsPlaces', '\\Model\\DistributionPlace\\DistributionsPlaces', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':eventid',
    1 => ':eventid',
        ...
        $this->addRelation('EventsPrinters', '\\Model\\Event\\EventsPrinters', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':eventid',
    1 => ':eventid',
        ...
        $this->addRelation('EventsTables', '\\Model\\Event\\EventsTables', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':eventid',
    1 => ':eventid',
  ...
  array (
    ...
    1 => ':eventid',
        ...
        $this->addRelation('MenuSizes', '\\Model\\Menues\\MenuSizes', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':eventid',
    1 => ':eventid',
        ...
        $this->addRelation('MenuTypes', '\\Model\\Menues\\MenuTypes', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':eventid',
    1 => ':eventid',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Model\Event\Events) { // it's a model object
