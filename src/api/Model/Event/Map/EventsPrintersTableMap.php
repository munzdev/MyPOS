...
class EventsPrintersTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.Event.Map.EventsPrintersTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\Event\\EventsPrinters';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.Event.EventsPrinters';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Model\\Event\\EventsPrinters');
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \Model\Event\EventsPrinters $obj A \Model\Event\EventsPrinters object.
     ...
     *
     * @param mixed $value A \Model\Event\EventsPrinters object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Model\Event\EventsPrinters) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \Model\Event\EventsPrinters object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Model\Event\EventsPrinters) { // it's a model object
