...
class EventsTablesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.Event.Map.EventsTablesTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\Event\\EventsTables';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.Event.EventsTables';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Model\\Event\\EventsTables');
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \Model\Event\EventsTables $obj A \Model\Event\EventsTables object.
     ...
     *
     * @param mixed $value A \Model\Event\EventsTables object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Model\Event\EventsTables) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \Model\Event\EventsTables object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Model\Event\EventsTables) { // it's a model object
