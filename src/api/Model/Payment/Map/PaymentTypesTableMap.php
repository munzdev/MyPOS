...
use Model\Payment\PaymentTypes;
use Model\Payment\PaymentTypesQuery;
...
class PaymentTypesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.Payment.Map.PaymentTypesTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\Payment\\PaymentTypes';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.Payment.PaymentTypes';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Model\\Payment\\PaymentTypes');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Model\Payment\PaymentTypes) { // it's a model object
