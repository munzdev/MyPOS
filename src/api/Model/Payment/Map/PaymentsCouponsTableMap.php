...
use Model\Payment\PaymentsCoupons;
use Model\Payment\PaymentsCouponsQuery;
...
class PaymentsCouponsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.Payment.Map.PaymentsCouponsTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\Payment\\PaymentsCoupons';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.Payment.PaymentsCoupons';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Model\\Payment\\PaymentsCoupons');
    ...
    {
        $this->addRelation('Coupons', '\\Model\\Payment\\Coupons', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':couponid',
    1 => ':couponid',
        ...
        $this->addRelation('Payments', '\\Model\\Payment\\Payments', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':paymentid',
    1 => ':paymentid',
     ...
     * and findPk*() calls.
     *
     * @param \Model\Payment\PaymentsCoupons $obj A \Model\Payment\PaymentsCoupons object.
     ...
     *
     * @param mixed $value A \Model\Payment\PaymentsCoupons object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Model\Payment\PaymentsCoupons) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \Model\Payment\PaymentsCoupons object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Model\Payment\PaymentsCoupons) { // it's a model object
