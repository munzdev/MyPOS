 ...
 *
 * @method     \Model\Event\EventsQuery|\Model\User\UsersQuery|\Model\Payment\PaymentsCouponsQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class CouponsQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Model\Payment\Base\CouponsQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Model\\Payment\\Coupons', $modelAlias = null)
    {
