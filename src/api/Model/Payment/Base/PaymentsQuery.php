 ...
 *
 * @method     \Model\Invoice\InvoicesQuery|\Model\Payment\PaymentTypesQuery|\Model\Payment\PaymentsCouponsQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class PaymentsQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Model\Payment\Base\PaymentsQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Model\\Payment\\Payments', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \Model\Payment\PaymentTypes object
     *
     * @param \Model\Payment\PaymentTypes|ObjectCollection $paymentTypes The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($paymentTypes instanceof \Model\Payment\PaymentTypes) {
            return $this
            ...
            throw new PropelException('filterByPaymentTypes() only accepts arguments of type \Model\Payment\PaymentTypes or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Model\Payment\PaymentTypesQuery A secondary query class using the current class as primary query
     */
    public function usePaymentTypesQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'PaymentTypes', '\Model\Payment\PaymentTypesQuery');
    }

    /**
     * Filter the query by a related \Model\Payment\PaymentsCoupons object
     *
     * @param \Model\Payment\PaymentsCoupons|ObjectCollection $paymentsCoupons the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildPaymentsQuery The current query, for fluid interface
     */
    ...
    {
        if ($paymentsCoupons instanceof \Model\Payment\PaymentsCoupons) {
            return $this
            ...
            throw new PropelException('filterByPaymentsCoupons() only accepts arguments of type \Model\Payment\PaymentsCoupons or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Model\Payment\PaymentsCouponsQuery A secondary query class using the current class as primary query
     */
    public function usePaymentsCouponsQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'PaymentsCoupons', '\Model\Payment\PaymentsCouponsQuery');
    }
