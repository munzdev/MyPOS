...
use Model\Payment\Map\PaymentTypesTableMap;
...
/**
 * Base class that represents a row from the 'payment_types' table.
 *
 *
 *
 * @package    propel.generator.Model.Payment.Base
 */
abstract class PaymentTypes implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Payment\\Map\\PaymentTypesTableMap';
    ...
    /**
     * The value for the idpayment_typeid field.
     *
     * @var        int
     */
    protected $idpayment_typeid;
    ...
    /**
     * Initializes internal state of Model\Payment\Base\PaymentTypes object.
     */
    ...
    /**
     * Compares this with another <code>PaymentTypes</code> instance.  If
     * <code>obj</code> is an instance of <code>PaymentTypes</code>, delegates to
     * <code>equals(PaymentTypes)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|PaymentTypes The current object, for fluid interface
     */
    ...
    /**
     * Get the [idpayment_typeid] column value.
     *
     * @return int
     */
    public function getIdpaymentTypeid()
    {
        return $this->idpayment_typeid;
    }
    ...
    /**
     * Set the value of [idpayment_typeid] column.
     *
     * @param int $v new value
     * @return $this|\Model\Payment\PaymentTypes The current object (for fluent API support)
     */
    public function setIdpaymentTypeid($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->idpayment_typeid !== $v) {
            $this->idpayment_typeid = $v;
            $this->modifiedColumns[PaymentTypesTableMap::COL_IDPAYMENT_TYPEID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[PaymentTypesTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PaymentTypesTableMap::translateFieldName('IdpaymentTypeid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->idpayment_typeid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PaymentTypesTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = PaymentTypesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\Payment\\PaymentTypes'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPaymentTypesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see PaymentTypes::setDeleted()
     * @see PaymentTypes::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPaymentTypesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PaymentTypesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->paymentssScheduledForDeletion !== null) {
                if (!$this->paymentssScheduledForDeletion->isEmpty()) {
                    \Model\Payment\PaymentsQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PaymentTypesTableMap::COL_IDPAYMENT_TYPEID)) {
            $modifiedColumns[':p' . $index++]  = 'idpayment_typeid';
        }
        if ($this->isColumnModified(PaymentTypesTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }

        $sql = sprintf(
            'INSERT INTO payment_types (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'idpayment_typeid':
                        $stmt->bindValue($identifier, $this->idpayment_typeid, PDO::PARAM_INT);
                        break;
                    case 'name':
    ...
    {
        $pos = PaymentTypesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIdpaymentTypeid();
                break;
            case 1:
                return $this->getName();
                break;
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['PaymentTypes'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PaymentTypes'][$this->hashCode()] = true;
        $keys = PaymentTypesTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdpaymentTypeid(),
            $keys[1] => $this->getName(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Model\Payment\PaymentTypes
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIdpaymentTypeid($arr[$keys[0]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\Payment\PaymentTypes The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PaymentTypesTableMap::COL_IDPAYMENT_TYPEID)) {
            $criteria->add(PaymentTypesTableMap::COL_IDPAYMENT_TYPEID, $this->idpayment_typeid);
        }
        if ($this->isColumnModified(PaymentTypesTableMap::COL_NAME)) {
            $criteria->add(PaymentTypesTableMap::COL_NAME, $this->name);
        }
    ...
    {
        $criteria = ChildPaymentTypesQuery::create();
        $criteria->add(PaymentTypesTableMap::COL_IDPAYMENT_TYPEID, $this->idpayment_typeid);
    ...
    {
        $validPk = null !== $this->getIdpaymentTypeid();
    ...
    /**
     * Generic method to set the primary key (idpayment_typeid column).
     *
    ...
    {
        return null === $this->getIdpaymentTypeid();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\Payment\PaymentTypes (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdpaymentTypeid(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Payment\PaymentTypes Clone of current object.
     * @throws PropelException
     */
    ...
    public function initPaymentss($overrideExisting = true)
    {
        ...
        $this->collPaymentss->setModel('\Model\Payment\Payments');
    }
     ...
     * If this ChildPaymentTypes is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildPaymentTypes The current object (for fluent API support)
     */
    public function setPaymentss(Collection $paymentss, ConnectionInterface $con = null)
    {
        ...
        foreach ($paymentssToDelete as $paymentsRemoved) {
            $paymentsRemoved->setPaymentTypes(null);
        }
     ...
     * Otherwise if this PaymentTypes is new, it will return
     * an empty collection; or if this PaymentTypes has previously
     * been saved, it will retrieve related Paymentss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in PaymentTypes.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildPayments[] List of ChildPayments objects
     */
    public function getPaymentssJoinInvoices(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildPaymentsQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(PaymentTypesTableMap::DEFAULT_STRING_FORMAT);
    }
