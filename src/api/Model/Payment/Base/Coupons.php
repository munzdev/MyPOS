...
abstract class Coupons implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Payment\\Map\\CouponsTableMap';
    ...
    /**
     * Initializes internal state of Model\Payment\Base\Coupons object.
     */
     ...
     * @return $this|\Model\Payment\Coupons The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\Payment\\Coupons'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Model\Payment\Coupons
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\Payment\Coupons The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\Payment\Coupons (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Payment\Coupons Clone of current object.
     * @throws PropelException
     */
