...
class InvoicesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.Invoice.Map.InvoicesTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\Invoice\\Invoices';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.Invoice.Invoices';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Model\\Invoice\\Invoices');
  ...
  array (
    ...
    1 => ':invoiceid',
        ...
        $this->addRelation('Payments', '\\Model\\Payment\\Payments', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':invoiceid',
    1 => ':invoiceid',
     ...
     * and findPk*() calls.
     *
     * @param \Model\Invoice\Invoices $obj A \Model\Invoice\Invoices object.
     ...
     *
     * @param mixed $value A \Model\Invoice\Invoices object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Model\Invoice\Invoices) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \Model\Invoice\Invoices object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Model\Invoice\Invoices) { // it's a model object
