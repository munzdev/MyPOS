 ...
 *
 * @method     \Model\User\UsersQuery|\Model\Invoice\InvoicesItemsQuery|\Model\Payment\PaymentsQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class InvoicesQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Model\Invoice\Base\InvoicesQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Model\\Invoice\\Invoices', $modelAlias = null)
    {
     ...
     *
     * @param \Model\Payment\Payments|ObjectCollection $payments the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildInvoicesQuery The current query, for fluid interface
     */
