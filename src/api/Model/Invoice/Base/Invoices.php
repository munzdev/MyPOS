...
use Model\Payment\Base\Payments as BasePayments;
...
abstract class Invoices implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Invoice\\Map\\InvoicesTableMap';
    ...
    /**
     * Initializes internal state of Model\Invoice\Base\Invoices object.
     */
     ...
     * @return $this|\Model\Invoice\Invoices The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\Invoice\\Invoices'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Model\Invoice\Invoices
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\Invoice\Invoices The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\Invoice\Invoices (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Invoice\Invoices Clone of current object.
     * @throws PropelException
     */
