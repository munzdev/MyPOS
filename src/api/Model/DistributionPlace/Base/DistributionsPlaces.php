...
use Model\DistributionPlace\DistributionsPlacesUsers as ChildDistributionsPlacesUsers;
...
abstract class DistributionsPlaces implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\DistributionPlace\\Map\\DistributionsPlacesTableMap';
    ...
    /**
     * Initializes internal state of Model\DistributionPlace\Base\DistributionsPlaces object.
     */
     ...
     * @return $this|\Model\DistributionPlace\DistributionsPlaces The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\DistributionPlace\\DistributionsPlaces'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Model\DistributionPlace\DistributionsPlaces
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\DistributionPlace\DistributionsPlaces The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\DistributionPlace\DistributionsPlaces (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\DistributionPlace\DistributionsPlaces Clone of current object.
     * @throws PropelException
     */
