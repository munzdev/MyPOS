 ...
 *
 * @method     \Model\DistributionPlace\DistributionsPlacesQuery|\Model\User\UsersQuery|\Model\Event\EventsPrintersQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class DistributionsPlacesUsersQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Model\DistributionPlace\Base\DistributionsPlacesUsersQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Model\\DistributionPlace\\DistributionsPlacesUsers', $modelAlias = null)
    {
     ...
     *
     * @param \Model\Event\EventsPrinters|ObjectCollection $eventsPrinters The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
