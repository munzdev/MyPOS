 ...
 *
 * @method     \Model\Event\EventsQuery|\Model\DistributionPlace\DistributionsPlacesGroupesQuery|\Model\DistributionPlace\DistributionsPlacesTablesQuery|\Model\DistributionPlace\DistributionsPlacesUsersQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class DistributionsPlacesQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Model\DistributionPlace\Base\DistributionsPlacesQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Model\\DistributionPlace\\DistributionsPlaces', $modelAlias = null)
    {
