 ...
 *
 * @method     \Model\Menues\MenuesPossibleExtrasQuery|\Model\Ordering\OrdersDetailsQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class OrdersDetailExtrasQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Model\Ordering\Base\OrdersDetailExtrasQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Model\\Ordering\\OrdersDetailExtras', $modelAlias = null)
    {
     ...
     *
     * @param \Model\Menues\MenuesPossibleExtras|ObjectCollection $menuesPossibleExtras The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
