 ...
 *
 * @method     \Model\Event\EventsQuery|\Model\Event\EventsTablesQuery|\Model\User\UsersQuery|\Model\Ordering\OrdersDetailsQuery|\Model\OIP\OrdersInProgressQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class OrdersQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Model\Ordering\Base\OrdersQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Model\\Ordering\\Orders', $modelAlias = null)
    {
