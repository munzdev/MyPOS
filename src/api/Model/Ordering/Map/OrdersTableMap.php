...
class OrdersTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.Ordering.Map.OrdersTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\Ordering\\Orders';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.Ordering.Orders';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Model\\Ordering\\Orders');
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \Model\Ordering\Orders $obj A \Model\Ordering\Orders object.
     ...
     *
     * @param mixed $value A \Model\Ordering\Orders object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Model\Ordering\Orders) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \Model\Ordering\Orders object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Model\Ordering\Orders) { // it's a model object
