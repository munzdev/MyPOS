...
class UserRoleTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.User.Map.UserRoleTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\User\\UserRole';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.User.UserRole';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Model\\User\\UserRole');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Model\User\UserRole) { // it's a model object
