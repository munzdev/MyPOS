...
use Model\DistributionPlace\Base\DistributionsPlacesUsers as BaseDistributionsPlacesUsers;
...
use Model\Event\Base\EventsUser as BaseEventsUser;
use Model\Event\Map\EventsUserTableMap;
use Model\Invoice\Invoices;
use Model\Invoice\InvoicesQuery;
use Model\Invoice\Base\Invoices as BaseInvoices;
use Model\Invoice\Map\InvoicesTableMap;
...
use Model\User\Users as ChildUsers;
use Model\User\UsersQuery as ChildUsersQuery;
use Model\User\Map\UsersTableMap;
 ...
 *
 *
 * @package    propel.generator.Model.User.Base
 */
abstract class Users implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\User\\Map\\UsersTableMap';
    ...
    /**
     * Initializes internal state of Model\User\Base\Users object.
     */
     ...
     * @return $this|\Model\User\Users The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\User\\Users'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->distributionsPlacesUserssScheduledForDeletion !== null) {
                if (!$this->distributionsPlacesUserssScheduledForDeletion->isEmpty()) {
                    \Model\DistributionPlace\DistributionsPlacesUsersQuery::create()
            ...
            if ($this->invoicessScheduledForDeletion !== null) {
                if (!$this->invoicessScheduledForDeletion->isEmpty()) {
                    \Model\Invoice\InvoicesQuery::create()
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\User\Users The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\User\Users (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\User\Users Clone of current object.
     * @throws PropelException
     */
    ...
    public function initDistributionsPlacesUserss($overrideExisting = true)
    {
        ...
        $this->collDistributionsPlacesUserss->setModel('\Model\DistributionPlace\DistributionsPlacesUsers');
    }
    ...
    public function initInvoicess($overrideExisting = true)
    {
        ...
        $this->collInvoicess->setModel('\Model\Invoice\Invoices');
    }
