 ...
 *
 * @method     \Model\Payment\CouponsQuery|\Model\DistributionPlace\DistributionsPlacesUsersQuery|\Model\Event\EventsUserQuery|\Model\Invoice\InvoicesQuery|\Model\Ordering\OrdersQuery|\Model\Ordering\OrdersDetailsQuery|\Model\OIP\OrdersInProgressQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class UsersQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Model\User\Base\UsersQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Model\\User\\Users', $modelAlias = null)
    {
     ...
     *
     * @param \Model\Invoice\Invoices|ObjectCollection $invoices the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildUsersQuery The current query, for fluid interface
     */
