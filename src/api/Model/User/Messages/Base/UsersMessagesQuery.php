...
namespace Model\User\Messages\Base;

use \Exception;
use \PDO;
use Model\Event\EventsUser;
use Model\User\Messages\UsersMessages as ChildUsersMessages;
use Model\User\Messages\UsersMessagesQuery as ChildUsersMessagesQuery;
 ...
 *
 * @method     \Model\Event\EventsUserQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class UsersMessagesQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Model\User\Messages\Base\UsersMessagesQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Model\\User\\Messages\\UsersMessages', $modelAlias = null)
    {
     ...
     *
     * @param \Model\Event\EventsUser|ObjectCollection $eventsUser The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    public function filterByEventsUserRelatedByFromEventsUserid($eventsUser, $comparison = null)
    {
        if ($eventsUser instanceof \Model\Event\EventsUser) {
            ...
            throw new PropelException('filterByEventsUserRelatedByFromEventsUserid() only accepts arguments of type \Model\Event\EventsUser or Collection');
        }
    }
    ...
    public function useEventsUserRelatedByFromEventsUseridQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'EventsUserRelatedByFromEventsUserid', '\Model\Event\EventsUserQuery');
    }
    ...
    public function filterByEventsUserRelatedByToEventsUserid($eventsUser, $comparison = null)
    {
        if ($eventsUser instanceof \Model\Event\EventsUser) {
            ...
            throw new PropelException('filterByEventsUserRelatedByToEventsUserid() only accepts arguments of type \Model\Event\EventsUser or Collection');
        }
    }
    ...
    public function useEventsUserRelatedByToEventsUseridQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'EventsUserRelatedByToEventsUserid', '\Model\Event\EventsUserQuery');
    }
