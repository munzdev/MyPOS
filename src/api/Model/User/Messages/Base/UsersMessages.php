 ...
 *
 *
 * @package    propel.generator.Model.User.Messages.Base
 */
abstract class UsersMessages implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\User\\Messages\\Map\\UsersMessagesTableMap';
    ...
    /**
     * Initializes internal state of Model\User\Messages\Base\UsersMessages object.
     */
     ...
     * @return $this|\Model\User\Messages\UsersMessages The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\User\\Messages\\UsersMessages'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Model\User\Messages\UsersMessages
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\User\Messages\UsersMessages The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\User\Messages\UsersMessages (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\User\Messages\UsersMessages Clone of current object.
     * @throws PropelException
     */
