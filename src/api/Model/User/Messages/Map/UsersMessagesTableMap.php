...
namespace Model\User\Messages\Map;

use Model\User\Messages\UsersMessages;
use Model\User\Messages\UsersMessagesQuery;
...
class UsersMessagesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.User.Messages.Map.UsersMessagesTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\User\\Messages\\UsersMessages';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.User.Messages.UsersMessages';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Model\\User\\Messages\\UsersMessages');
        $this->setPackage('Model.User.Messages');
    ...
    {
        $this->addRelation('EventsUserRelatedByFromEventsUserid', '\\Model\\Event\\EventsUser', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    ...
    1 => ':events_userid',
        ...
        $this->addRelation('EventsUserRelatedByToEventsUserid', '\\Model\\Event\\EventsUser', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':to_events_userid',
    1 => ':events_userid',
     ...
     * and findPk*() calls.
     *
     * @param \Model\User\Messages\UsersMessages $obj A \Model\User\Messages\UsersMessages object.
     ...
     *
     * @param mixed $value A \Model\User\Messages\UsersMessages object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Model\User\Messages\UsersMessages) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \Model\User\Messages\UsersMessages object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Model\User\Messages\UsersMessages) { // it's a model object
