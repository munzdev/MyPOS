...
abstract class MenuExtras implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Menues\\Map\\MenuExtrasTableMap';
    ...
    /**
     * Initializes internal state of Model\Menues\Base\MenuExtras object.
     */
     ...
     * @return $this|\Model\Menues\MenuExtras The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\Menues\\MenuExtras'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Model\Menues\MenuExtras
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\Menues\MenuExtras The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\Menues\MenuExtras (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Menues\MenuExtras Clone of current object.
     * @throws PropelException
     */
