...
class MenuesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.Menues.Map.MenuesTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\Menues\\Menues';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.Menues.Menues';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Model\\Menues\\Menues');
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \Model\Menues\Menues $obj A \Model\Menues\Menues object.
     ...
     *
     * @param mixed $value A \Model\Menues\Menues object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Model\Menues\Menues) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \Model\Menues\Menues object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Model\Menues\Menues) { // it's a model object
