...
class MenuExtrasTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.Menues.Map.MenuExtrasTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\Menues\\MenuExtras';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.Menues.MenuExtras';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Model\\Menues\\MenuExtras');
  ...
  array (
    ...
    1 => ':eventid',
        ...
        $this->addRelation('MenuesPossibleExtras', '\\Model\\Menues\\MenuesPossibleExtras', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':menu_extraid',
    1 => ':menu_extraid',
     ...
     * and findPk*() calls.
     *
     * @param \Model\Menues\MenuExtras $obj A \Model\Menues\MenuExtras object.
     ...
     *
     * @param mixed $value A \Model\Menues\MenuExtras object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Model\Menues\MenuExtras) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \Model\Menues\MenuExtras object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Model\Menues\MenuExtras) { // it's a model object
