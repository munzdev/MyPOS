...
define(["app"], function()
{
    ...
    class MyPOS {
        RenderPageTemplate(View, Name, Template, Datas)
        {
        ...
        RenderDialogeTemplate(View, Name, Template, Datas)
        {
            // Sets the view's template property
            View.template = _.template(Template);
        ...
        RenderPopupTemplate(View, Name, Template, Datas, Extras)
        {
            // Sets the view's template property
            View.template = _.template(Template);
