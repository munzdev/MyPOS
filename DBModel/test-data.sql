...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `user` (`userid`, `username`, `password`, `firstname`, `lastname`, `autologin_hash`, `active`, `phonenumber`, `call_request`, `is_admin`) VALUES (DEFAULT, 'admin', MD5('password'), 'Administrator', 'Cool', NULL, 1, '0664 / 1234567', NULL, true);
INSERT INTO `user` (`userid`, `username`, `password`, `firstname`, `lastname`, `autologin_hash`, `active`, `phonenumber`, `call_request`, `is_admin`) VALUES (DEFAULT, 'kellner', MD5('password'), 'Kellner', 'Schnell', NULL, 1, '0664 / 7654321', NULL, false);
INSERT INTO `user` (`userid`, `username`, `password`, `firstname`, `lastname`, `autologin_hash`, `active`, `phonenumber`, `call_request`, `is_admin`) VALUES (DEFAULT, 'essen', MD5('password'), 'Ausgabe', 'Essen', NULL, 1, '0664 5555555', NULL, false);
INSERT INTO `user` (`userid`, `username`, `password`, `firstname`, `lastname`, `autologin_hash`, `active`, `phonenumber`, `call_request`, `is_admin`) VALUES (DEFAULT, 'trinken1-1', MD5('password'), 'Ausgabe', 'Trinken 1-1', NULL, 1, '0664 1111111', NULL, false);
INSERT INTO `user` (`userid`, `username`, `password`, `firstname`, `lastname`, `autologin_hash`, `active`, `phonenumber`, `call_request`, `is_admin`) VALUES (DEFAULT, 'manager', MD5('password'), 'Manager', 'Nur', NULL, 1, '0664 8888888', NULL, false);
INSERT INTO `user` (`userid`, `username`, `password`, `firstname`, `lastname`, `autologin_hash`, `active`, `phonenumber`, `call_request`, `is_admin`) VALUES (DEFAULT, 'managerAll', MD5('password'), 'Manager', 'Alles', NULL, 1, '0664 9999999', NULL, false);
INSERT INTO `user` (`userid`, `username`, `password`, `firstname`, `lastname`, `autologin_hash`, `active`, `phonenumber`, `call_request`, `is_admin`) VALUES (DEFAULT, 'trinken2', MD5('password'), 'Ausgabe', 'Trinken 2', NULL, 1, '0664 2222222', NULL, false);
INSERT INTO `user` (`userid`, `username`, `password`, `firstname`, `lastname`, `autologin_hash`, `active`, `phonenumber`, `call_request`, `is_admin`) VALUES (DEFAULT, 'trinken1-2', MD5('password'), 'Ausgabe', 'Trinken 1-2', NULL, 1, '0664 3333333', NULL, false);
...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `order_detail` (`order_detailid`, `orderid`, `menuid`, `menu_sizeid`, `menu_groupid`, `amount`, `single_price`, `single_price_modified_by_userid`, `extra_detail`, `finished`, `availabilityid`, `availability_amount`, `verified`) VALUES (DEFAULT, 1, 1, NULL, NULL, 2, 7.50, NULL, NULL, NULL, NULL, NULL, DEFAULT);
INSERT INTO `order_detail` (`order_detailid`, `orderid`, `menuid`, `menu_sizeid`, `menu_groupid`, `amount`, `single_price`, `single_price_modified_by_userid`, `extra_detail`, `finished`, `availabilityid`, `availability_amount`, `verified`) VALUES (DEFAULT, 1, 2, NULL, NULL, 1, 9, NULL, NULL, NULL, NULL, NULL, DEFAULT);
INSERT INTO `order_detail` (`order_detailid`, `orderid`, `menuid`, `menu_sizeid`, `menu_groupid`, `amount`, `single_price`, `single_price_modified_by_userid`, `extra_detail`, `finished`, `availabilityid`, `availability_amount`, `verified`) VALUES (DEFAULT, 2, 8, NULL, NULL, 3, 2.5, NULL, NULL, NULL, NULL, NULL, DEFAULT);
INSERT INTO `order_detail` (`order_detailid`, `orderid`, `menuid`, `menu_sizeid`, `menu_groupid`, `amount`, `single_price`, `single_price_modified_by_userid`, `extra_detail`, `finished`, `availabilityid`, `availability_amount`, `verified`) VALUES (DEFAULT, 2, 14, NULL, NULL, 2, 2.80, NULL, NULL, NULL, NULL, NULL, DEFAULT);
INSERT INTO `order_detail` (`order_detailid`, `orderid`, `menuid`, `menu_sizeid`, `menu_groupid`, `amount`, `single_price`, `single_price_modified_by_userid`, `extra_detail`, `finished`, `availabilityid`, `availability_amount`, `verified`) VALUES (DEFAULT, 3, 8, NULL, NULL, 1, 4, NULL, NULL, NULL, NULL, NULL, DEFAULT);
INSERT INTO `order_detail` (`order_detailid`, `orderid`, `menuid`, `menu_sizeid`, `menu_groupid`, `amount`, `single_price`, `single_price_modified_by_userid`, `extra_detail`, `finished`, `availabilityid`, `availability_amount`, `verified`) VALUES (DEFAULT, 4, 1, NULL, NULL, 2, 7.50, NULL, NULL, NULL, NULL, NULL, DEFAULT);
INSERT INTO `order_detail` (`order_detailid`, `orderid`, `menuid`, `menu_sizeid`, `menu_groupid`, `amount`, `single_price`, `single_price_modified_by_userid`, `extra_detail`, `finished`, `availabilityid`, `availability_amount`, `verified`) VALUES (DEFAULT, 4, 2, NULL, NULL, 1, 6.50, NULL, NULL, NULL, NULL, NULL, DEFAULT);
...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `event_printer` (`event_printerid`, `eventid`, `name`, `ip`, `port`, `default`, `characters_per_row`) VALUES (DEFAULT, 1, 'Default', '192.168.0.50', 9100, 1, 48);
