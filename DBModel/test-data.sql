...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `users` (`userid`, `username`, `password`, `firstname`, `lastname`, `autologin_hash`, `active`, `phonenumber`, `call_request`, `is_admin`) VALUES (DEFAULT, 'admin', '$2y$10$og9U0.a3fLAalSfUwwCRl.IHfcLoX.E11GpoiOJ7ZhUuDHSaFCZHy', 'Administrator', 'Cool', NULL, 1, '0664 / 1234567', NULL, true);
INSERT INTO `users` (`userid`, `username`, `password`, `firstname`, `lastname`, `autologin_hash`, `active`, `phonenumber`, `call_request`, `is_admin`) VALUES (DEFAULT, 'kellner', '$2y$10$og9U0.a3fLAalSfUwwCRl.IHfcLoX.E11GpoiOJ7ZhUuDHSaFCZHy', 'Kellner', 'Schnell', NULL, 1, '0664 / 7654321', NULL, false);
INSERT INTO `users` (`userid`, `username`, `password`, `firstname`, `lastname`, `autologin_hash`, `active`, `phonenumber`, `call_request`, `is_admin`) VALUES (DEFAULT, 'essen', '$2y$10$og9U0.a3fLAalSfUwwCRl.IHfcLoX.E11GpoiOJ7ZhUuDHSaFCZHy', 'Ausgabe', 'Essen', NULL, 1, '0664 5555555', NULL, false);
INSERT INTO `users` (`userid`, `username`, `password`, `firstname`, `lastname`, `autologin_hash`, `active`, `phonenumber`, `call_request`, `is_admin`) VALUES (DEFAULT, 'trinken1-1', '$2y$10$og9U0.a3fLAalSfUwwCRl.IHfcLoX.E11GpoiOJ7ZhUuDHSaFCZHy', 'Ausgabe', 'Trinken 1-1', NULL, 1, '0664 1111111', NULL, false);
INSERT INTO `users` (`userid`, `username`, `password`, `firstname`, `lastname`, `autologin_hash`, `active`, `phonenumber`, `call_request`, `is_admin`) VALUES (DEFAULT, 'manager', '$2y$10$og9U0.a3fLAalSfUwwCRl.IHfcLoX.E11GpoiOJ7ZhUuDHSaFCZHy', 'Manager', 'Nur', NULL, 1, '0664 8888888', NULL, false);
INSERT INTO `users` (`userid`, `username`, `password`, `firstname`, `lastname`, `autologin_hash`, `active`, `phonenumber`, `call_request`, `is_admin`) VALUES (DEFAULT, 'managerAll', '$2y$10$og9U0.a3fLAalSfUwwCRl.IHfcLoX.E11GpoiOJ7ZhUuDHSaFCZHy', 'Manager', 'Alles', NULL, 1, '0664 9999999', NULL, false);
INSERT INTO `users` (`userid`, `username`, `password`, `firstname`, `lastname`, `autologin_hash`, `active`, `phonenumber`, `call_request`, `is_admin`) VALUES (DEFAULT, 'trinken2', '$2y$10$og9U0.a3fLAalSfUwwCRl.IHfcLoX.E11GpoiOJ7ZhUuDHSaFCZHy', 'Ausgabe', 'Trinken 2', NULL, 1, '0664 2222222', NULL, false);
INSERT INTO `users` (`userid`, `username`, `password`, `firstname`, `lastname`, `autologin_hash`, `active`, `phonenumber`, `call_request`, `is_admin`) VALUES (DEFAULT, 'trinken1-2', '$2y$10$og9U0.a3fLAalSfUwwCRl.IHfcLoX.E11GpoiOJ7ZhUuDHSaFCZHy', 'Ausgabe', 'Trinken 1-2', NULL, 1, '0664 3333333', NULL, false);
