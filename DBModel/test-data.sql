...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `order_detail` (`order_detailid`, `orderid`, `menuid`, `menu_sizeid`, `menu_groupid`, `amount`, `single_price`, `single_price_modified_by_userid`, `extra_detail`, `availabilityid`, `availability_amount`, `verified`, `distribution_finished`, `invoice_finished`) VALUES (DEFAULT, 1, 1, 1, NULL, 2, 7.50, NULL, NULL, 1, NULL, DEFAULT, NULL, NULL);
INSERT INTO `order_detail` (`order_detailid`, `orderid`, `menuid`, `menu_sizeid`, `menu_groupid`, `amount`, `single_price`, `single_price_modified_by_userid`, `extra_detail`, `availabilityid`, `availability_amount`, `verified`, `distribution_finished`, `invoice_finished`) VALUES (DEFAULT, 1, 2, 1, NULL, 1, 9, NULL, NULL, 1, NULL, DEFAULT, NULL, NULL);
INSERT INTO `order_detail` (`order_detailid`, `orderid`, `menuid`, `menu_sizeid`, `menu_groupid`, `amount`, `single_price`, `single_price_modified_by_userid`, `extra_detail`, `availabilityid`, `availability_amount`, `verified`, `distribution_finished`, `invoice_finished`) VALUES (DEFAULT, 2, 8, 3, NULL, 3, 2.5, NULL, NULL, 1, NULL, DEFAULT, NULL, NULL);
INSERT INTO `order_detail` (`order_detailid`, `orderid`, `menuid`, `menu_sizeid`, `menu_groupid`, `amount`, `single_price`, `single_price_modified_by_userid`, `extra_detail`, `availabilityid`, `availability_amount`, `verified`, `distribution_finished`, `invoice_finished`) VALUES (DEFAULT, 2, 14, 5, NULL, 2, 2.80, NULL, NULL, 1, NULL, DEFAULT, NULL, NULL);
INSERT INTO `order_detail` (`order_detailid`, `orderid`, `menuid`, `menu_sizeid`, `menu_groupid`, `amount`, `single_price`, `single_price_modified_by_userid`, `extra_detail`, `availabilityid`, `availability_amount`, `verified`, `distribution_finished`, `invoice_finished`) VALUES (DEFAULT, 3, 8, 2, NULL, 1, 4, NULL, NULL, 1, NULL, DEFAULT, NULL, NULL);
INSERT INTO `order_detail` (`order_detailid`, `orderid`, `menuid`, `menu_sizeid`, `menu_groupid`, `amount`, `single_price`, `single_price_modified_by_userid`, `extra_detail`, `availabilityid`, `availability_amount`, `verified`, `distribution_finished`, `invoice_finished`) VALUES (DEFAULT, 4, 1, 1, NULL, 2, 7.50, NULL, NULL, 1, NULL, DEFAULT, NULL, NULL);
INSERT INTO `order_detail` (`order_detailid`, `orderid`, `menuid`, `menu_sizeid`, `menu_groupid`, `amount`, `single_price`, `single_price_modified_by_userid`, `extra_detail`, `availabilityid`, `availability_amount`, `verified`, `distribution_finished`, `invoice_finished`) VALUES (DEFAULT, 4, 2, 1, NULL, 1, 6.50, NULL, NULL, 1, NULL, DEFAULT, NULL, NULL);
